            ...
            get
            {
                ...
                if (_DefaultVal.Contains("@"))
                {
                    ...
                    if (_DefaultVal.Contains("@WebUser.DeptNo"))
                        return _DefaultVal.Replace("@WebUser.DeptNo", WebUser.DeptNo);
                    ...
                    // 处理传递过来的参数。
                    //foreach (string k in System.Web.HttpContextHelper.Current.Request.QueryString.AllKeys)
                    //2019-07-25 zyt改造
                    ...
                    //foreach (string k in System.Web.HttpContextHelper.Current.Request.Form.AllKeys)
                    //{
                    //    if (_DefaultVal.Contains(k))
                    //        return _DefaultVal.Replace("@" + k, System.Web.HttpContextHelper.Current.Request.Form[k]);
                    //}
