...
namespace BP.En
{
    ...
    public class QueryObject
    {
        ...
        /// </summary>
        /// <param name="attr">属性</param>
        /// <param name="vals">用 , 分开的．1,2</param>
        ...
        /// in查询
        /// </summary>
        /// <param name="attr">字段</param>
        /// <param name="vals">1,2</param>
        public void AddWhereInSimple(string attr, string vals)
        {

            this.AddWhere(attr, " IN ", " (" + BP.Port.Glo.GenerWhereInSQL(vals) + ") ");
        }
        ...
        private string attr2Field(string attrKey)
        {
            ...
            if (attr.ItIsRefAttr == true)
            {
                ...
                if (this.HisDBType == DBType.DM || this.HisDBType == DBType.Oracle
                    || this.HisDBType == DBType.KingBaseR3
                    || this.HisDBType == DBType.KingBaseR8
                        || this.HisDBType == DBType.KingBaseR6
                        || this.HisDBType == DBType.GBASE8CByOracle)
                {
        ...
        public int DoQuery(string pk, int pageSize, int pageIdx, string orderBy, bool isDesc)
        {
            try
            {
                return this.DoQueryExt(pk, pageSize, pageIdx, orderBy, isDesc);
            }
            catch
            {
                try
        ...
        /// <returns>查询结果</returns>
        private int DoQueryExt(string pk, int pageSize, int pageIdx, string orderBy, bool isDesc)
        {
