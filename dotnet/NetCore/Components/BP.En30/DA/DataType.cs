...
namespace BP.DA
{
    ...
    public class DataType
    {
        public static bool IsNullOrEmpty(string s)
        {
            ...
            if (s == null || s.Equals("") == true || s.Equals("null") == true || s.Equals("NaN")==true || s.Equals("undefined") == true)
                return true;
            return false;
        }
        ...
        /// </summary>
        /// <returns></returns>
        public static void convertByteToFile(byte[] bytes, string fileFullPath)
        {

            string folder = System.IO.Path.GetDirectoryName(fileFullPath);
            ...
            System.IO.FileStream fs = new System.IO.FileStream(fileFullPath, System.IO.FileMode.Create, System.IO.FileAccess.Write);
        ...
        public static DataSet CXmlFileToDataSet(string xmlFilePath)
        {
            ...
            {
                //string path = HttpContextHelper.Current.Server.MapPath(xmlFilePath);
