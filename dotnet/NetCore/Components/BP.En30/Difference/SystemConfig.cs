...
namespace BP.Difference
{
    ...
    public class SystemConfig
    {
        ...
        public static string VstoExtensionVersion
        {
            get
            {
                return BP.Difference.SystemConfig.AppSettings["VstoExtensionVersion"];
            }
        }
        public static string DeptDefaultNo
        {
            get
            {
                return BP.Difference.SystemConfig.AppSettings["DeptDefaultNo"];
            }
        }
        #endregion
        /// <summary>
        ...
        public static string HostURLVue3
        {
            get
            {
        ...
        {
            // HttpRuntime.UnloadAppDomainExt();
        ...
        public static bool isDebug
        {
            get
            {
                if (AppSettings["IsDebug"].Equals( "1"))
                    return true;
                else
                    return false;
            }
        ...
        /// 是否首次登陆判断密码.
        /// </summary>
        public static bool IsPassWordChangeBYFirstLogin
        {
            get
            {
                return SystemConfig.GetValByKeyBoolen("IsPassWordChangeBYFirstLogin", false);
            }
        }
        ...
        public static string DomainExt
        {
            get
            {
                return AppSettings["DomainExt"];
            }
        }
        /// <summary>
        /// 客户简称
        ...
        public static string TodoCenter
        {
            get
            {
                string str = AppSettings["TodoCenter"] as string;
                if (str == null)
                    str = "";
                return str;
            }
        ...
        public static string AppCenterDBDatabase
        {
            get
            {
                ...
                switch (DBAccess.AppCenterDBType)
                {
                    ...
                    case DA.DBType.GBASE8CByOracle:
        ...
        public static string CryptographyKey
        {
            get
            {
                string s = BP.Difference.SystemConfig.AppSettings["CryptographyKey"];
                return s;
            }
        }
        ...
        public static string SerialNo
        {
            get
            {
                string s = BP.Difference.SystemConfig.AppSettings["SerialNo"];
                return s;
            }
        }
        public static string PreviewPathOfAth
        {
            get
            {
                string s = BP.Difference.SystemConfig.AppSettings["PreviewPathOfAth"];
                return s;
            }
        }
        public static string OrgName
        {
            get
            {
                string s = BP.Difference.SystemConfig.AppSettings["OrgName"];
                return s;
            }
        }
    }
