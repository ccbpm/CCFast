    ...
    public class SysEnumMain : EntityNoName
    {
        ...
        public SysEnumMain(string no)
        {
            ...
            catch (Exception ex)
            {
                ...
                {
                    if (no.Contains(WebUser.OrgNo) == false)
                    {
                        no = WebUser.OrgNo + "_" + no;
                        this.No = no;
                        this.Retrieve();
                    }
                }
        ...
        public string DoInitDtls()
        {
            ...
            foreach (string str in strs)
            {
                ...
                //序号.
                this.SetValByKey("Idx" + se.IntKey, se.IntKey);
                this.SetValByKey("Val" + se.IntKey, se.Lab);
            }
            this.Update();
            return "执行成功.";
        }
        ...
        {
            Cache.RemoveObj("EnumOf" + this.No + WebUser.SysLang);
            return "";
        }
        #endregion 业务操作。
