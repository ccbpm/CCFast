...
namespace BP.Sys.FrmUI
{
    ...
    public class MapAttrString : EntityMyPK
    {
        ...
        /// <returns></returns>
        public string DoRenameCH(string newField)
        {

            if (this.Name.Equals(newField) == true)
                return "err@与现在的名字相同.";
            ...
            DBAccess.RunSQL("UPDATE Sys_MapAttr SET Name='" + this.Name + "' WHERE MyPK='" + frmID + "_" + this.KeyOfEn + "'");
            return "更新成功,流程属性也更新.";
        }
        /// <summary>
        /// 字段重命名
        ...
        protected override bool beforeUpdateInsertAction()
        {
            ...
            if (attr.MaxLen < this.MaxLen)
            {
                ...
                {
                    if (DBAccess.IsExitsTableCol(md.PTable, this.KeyOfEn) == true && DBAccess.IsView(md.PTable) == false)
                    {
                        switch (BP.Difference.SystemConfig.AppCenterDBType)
                        {
                            case DBType.MSSQL:
