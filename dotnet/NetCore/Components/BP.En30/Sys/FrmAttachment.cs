...
namespace BP.Sys
{
    ...
    public class FrmAttachmentAttr : EntityMyPKAttr
    {
        ...
        /// 附件在綫編輯方式
        /// </summary>
        public const string AthEditType = "AthEditType";
        /// <summary>
        /// 附件删除方式
        /// </summary>
    ...
    public class FrmAttachment : EntityMyPK
    {
        ...
        public string SaveTo
        {
            get
            {
                string path = this.FrmID;

                if (this.AthSaveWay == BP.Sys.AthSaveWay.IISServer)
                {
                    path = BP.Difference.SystemConfig.PathOfDataUser + @"/UploadFile/" + this.FrmID + "/";
                }
        ...
        protected override void afterInsert()
        {
            ...
            if (this.NodeID == 0 && gf.IsExit(GroupFieldAttr.CtrlID, this.MyPK) == false)
            {
                ...
                gf.Idx = 0;
                gf.Insert(); //插入.
                DBAccess.RunSQL("UPDATE Sys_FrmAttachment SET GroupID=" + gf.OID + " WHERE MyPK='" + this.MyPK + "'");
