...
namespace BP.Sys
{
    ...
    /// 通用OID实体
    /// </summary>
    public class GEEntityOID : Entity
    {
        #region 构造函数
        /// <summary>
        /// 设置或者获取主键值.
        ...
        /// <param name="pk"></param>
        public GEEntityOID(string frmID, object pk)
        {
            this.FrmID = frmID;
            this.PKVal = pk;
            this._enMap = null;
        ...
        /// </summary>
        /// <param name="en"></param>
        public void CopyFromFrm(GEEntityOID en)
        {
            //先求出来旧的OID.
        ...
        public void SaveAsNew()
        {
            try
            {
                ...
                if (DBAccess.IsExitsTableCol(ptable, "DBFile") == true)
                {
                    ...
                    //保存到新记录里面.
                    DBAccess.SaveBytesToDB(val, ptable, "OID", this.OID.ToString(), "DBFile");
                }
    ...
    /// 通用OID实体s
    /// </summary>
    public class GEEntityOIDs : EntitiesOID
    {
        #region 重载基类方法
        public override string ToString()
        {
        ...
        public System.Collections.Generic.IList<GEEntityOID> ToJavaList()
        {
            return (System.Collections.Generic.IList<GEEntityOID>)this;
        }
        /// <summary>
        /// 转化成list
        /// </summary>
        /// <returns>List</returns>
        public System.Collections.Generic.List<GEEntityOID> Tolist()
        {
            System.Collections.Generic.List<GEEntityOID> list = new System.Collections.Generic.List<GEEntityOID>();
            for (int i = 0; i < this.Count; i++)
            {
                list.Add((GEEntityOID)this[i]);
            }
            return list;
        }
