	...
	public class SysDocFile : EntityMyPK
	{
		...
		public override Map EnMap
		{
            get
            {
                ...
                if (map.EnDBUrl.DBType == DBType.Oracle || map.EnDBUrl.DBType == DBType.KingBaseR3 || map.EnDBUrl.DBType == DBType.KingBaseR6 || map.EnDBUrl.DBType == DBType.MSSQL || DBAccess.AppCenterDBType == DBType.DM || DBAccess.AppCenterDBType == DBType.GBASE8CByOracle)
                {
