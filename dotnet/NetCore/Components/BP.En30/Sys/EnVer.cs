    ...
    public class EnVer : EntityMyPK
    {
        ...
        public static string NewVer(Entity myen)
        {
            ...
            foreach(MapAttr mapAttr in mapAttrs)
            {
                ...
                enVerDtl.RefPK = ev.MyPK;
                enVerDtl.EnPKValue = pkval;
                enVerDtl.FrmID = ev.FrmID;
                enVerDtl.AttrKey = mapAttr.KeyOfEn;
                enVerDtl.AttrName = mapAttr.Name;
                enVerDtl.BindKey = mapAttr.UIBindKey;
                enVerDtl.LGType = (int)mapAttr.LGType;
                enVerDtl.MyVal = myen.GetValByKey(mapAttr.KeyOfEn)!=null?myen.GetValByKey(mapAttr.KeyOfEn).ToString():"";
