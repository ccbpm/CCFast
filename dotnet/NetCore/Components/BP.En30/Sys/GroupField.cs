...
namespace BP.Sys
{
    ...
    public class GroupField : EntityOID
    {
        ...
        {
            string attrs = "'OID','Name','RDT','REC','RefPK','FID','BillNo','Title','Name','AtPara','BillState','FK_Dept','OrgNo','RDT','Starter','StarterName'";
            string sql = "DELETE FROM Sys_MapAttr WHERE FK_MapData='" + this.FrmID + "' AND GroupID=" + this.OID + " AND KeyOfEn NOT IN ("+ attrs + ")";
