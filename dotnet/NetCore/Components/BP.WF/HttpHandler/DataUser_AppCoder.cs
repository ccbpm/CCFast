...
namespace BP.WF.HttpHandler
{
    ...
    public class DataUser_AppCoder : BP.WF.HttpHandler.DirectoryPageBase
    {
        ...
        public string FlowDesignerWelcome_Init()
        {
            ...
            else if (SystemConfig.AppCenterDBType == DBType.Oracle || DBAccess.AppCenterDBType == DBType.GBASE8CByOracle || SystemConfig.AppCenterDBType == DBType.KingBaseR3 || SystemConfig.AppCenterDBType == DBType.KingBaseR6 || DBAccess.AppCenterDBType == DBType.DM)
            {
