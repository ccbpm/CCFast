...
namespace BP.WF.HttpHandler
{
    ...
    public class WF_AppClassic : DirectoryPageBase
    {
        ...
        public string Welcome_Init()
        {
            ...
            Hashtable ht = new Hashtable();
            // 待办.
            ht.Add("Todlist", BP.WF.Dev2Interface.Todolist_EmpWorks); //流程数
            ...
            ht.Add("OverTime", DBAccess.RunSQLReturnValInt("SELECT COUNT(WorkID) FROM WF_GenerWorkFlow WHERE WFState=2 AND WFSta=0  ")); //实例数.
        ...
        public string Welcome_EchartDataSet()
        {
            ...
            else if (BP.Difference.SystemConfig.AppCenterDBType == DBType.Oracle || BP.Difference.SystemConfig.AppCenterDBType == DBType.GBASE8CByOracle || BP.Difference.SystemConfig.AppCenterDBType == DBType.KingBaseR3 || BP.Difference.SystemConfig.AppCenterDBType == DBType.KingBaseR6 || DBAccess.AppCenterDBType == DBType.DM)
            {
