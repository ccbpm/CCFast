...
namespace BP.WF.HttpHandler
{
    abstract public class DirectoryPageBase
    {
        ...
        public string GetRequestFormVal(string key)
        {
            return HttpContextHelper.GetFormParams(key);
        }
        ...
        public string RptID
        {
            get
            {
                string str = this.GetRequestVal("RptID");
                return str;
            }
        }
        public string PageID
        {
            get
            {
                string str = this.GetRequestVal("PageID");
                return str;
            }
        }
        /// <summary>
