...
namespace BP.WF.HttpHandler
{
    ...
    public class WF_Admin_AttrNode_FrmSln : BP.WF.HttpHandler.DirectoryPageBase
    {
        ...
        public WF_Admin_AttrNode_FrmSln()
        {
	     ...
	     @return
	     */
	    public string SelfForm_SetAllNodeFrmUseThisSln()  {
		    ...
		    for (int i = 0; i < nds.Count; i++)
		    {
			    ...
			    jsNode.FormUrl =  currNode.FormUrl;
        ...
        public string RefOneFrmTree_SetAllNodeFrmUseThisSln()
        {
            ...
            for (int i = 0; i < nds.Count; i++)
            {
                ...
                for (int idx = 0; idx < ens.Count; idx++)
                {
                    ...
                    if (en.FrmID.Equals(currNode.NodeFrmID) == false)
                    {
                ...
                frmNode.FrmID = jsNode.NodeFrmID;
            ...
            //更新模式.
            Flow flow = new Flow(currNode.FlowNo);
            flow.FrmUrl = currNode.NodeFrmID;
            flow.FlowDevModel = FlowDevModel.RefOneFrmTree;
            flow.Update();
