...
namespace BP.WF.HttpHandler
{
    ...
    public class WF_Admin_Cond : DirectoryPageBase
    {
        ...
        public string CondByFrm_Init()
        {
            ...
            //增加字段集合.
            string sql = "";
            if (BP.Difference.SystemConfig.AppCenterDBType == DBType.Oracle || DBAccess.AppCenterDBType == DBType.GBASE8CByOracle || SystemConfig.AppCenterDBType == DBType.KingBaseR3 || SystemConfig.AppCenterDBType == DBType.KingBaseR6 || BP.Difference.SystemConfig.AppCenterDBType == DBType.PostgreSQL || BP.Difference.SystemConfig.AppCenterDBType == DBType.HGDB || BP.Difference.SystemConfig.AppCenterDBType == DBType.UX || DBAccess.AppCenterDBType == DBType.DM)
            {
