...
namespace BP.WF.HttpHandler
{
    ...
    public class WF_MyView : DirectoryPageBase
    {
        ...
        public string MyFrm_Init_Data()
        {
            ...
            if (i == 1)
            {
                String mainData = DBAccess.GetBigTextFromDB("Sys_FrmDBVer", "MyPK", ver.MyPK, "FrmDB");
                return mainData;
            }
            return "";
        }
        ...
        public string InitToolBar()
        {
            ...
            try
            {
                ...
                if (nd.HisFlow.GetParaBoolen("CCORShareEnable", false))
                {
                    dr = dt.NewRow();
                    dr["No"] = "CCORShare";
                    dr["Name"] = nd.HisFlow.GetParaString("CCORShareLab", "抄送/分享");
                    dr["Oper"] = "";
                    dt.Rows.Add(dr);
                }
        ...
        public string MyView_Init()
        {
            ...
            bool isReadonly = true; // = this.GetRequestValBoolen("IsReadonly");
            ...
            if (gwf.FID == 0 && gwf.IsOver==false && toDoEmps.Contains(";" + WebUser.No + ",") && isReadonly == false)
            {
                WF_MyFlow handler = new WF_MyFlow();
                handler.isMyView = true;
                return handler.MyFlow_Init();
            ...
            if (frmtype == NodeFormType.EntityTS)
            {
                ...
                string url = "MyFlowEntityTS.htm?EnName=" + formUrl + "&OID=" + this.WorkID + "&PKVal=" + this.WorkID + "&PageType=MyView";
        ...
        private string MyView_Init_DealUrl(BP.WF.Node currND, string url = null)
        {
            ...
            //string urlExt = this.RequestParas;  //防止Token重复拼接
            string urlExt = "";
            //防止查询不到.
