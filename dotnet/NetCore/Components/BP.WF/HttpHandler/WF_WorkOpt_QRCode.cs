...
namespace BP.WF.HttpHandler
{
    ...
    public class WF_WorkOpt_QRCode : BP.WF.HttpHandler.DirectoryPageBase
    {
        ...
        #region Vue3 二维码扫描接口
        public string GenerCode_Init_Vue3()
        {
            string url = BP.Difference.SystemConfig.HostURLVue3 + "/#/CCMobile/ScanGuide?WorkID=" + this.WorkID + "&FK_Node=" + this.NodeID + "&FK_Flow=" + this.FlowNo;
        ...
        public string ScanGuide_Init_Vue3()
        {
            if (this.NodeID == 0)
            {
            ...
            if (val == 1)
            {
                ...
                return "url@/CCMobile/MyView.htm?WorkID=" + this.WorkID + "&FK_Flow=" + this.FlowNo + "&FK_Node=" + this.NodeID + "&Token=" + token;
            }
            ...
            if (val == 2)
            {
                //判断是否登录?
                if (WebUser.No == null)
                    return "url@Login.htm?WorkID=" + this.WorkID + "&FK_Flow=" + this.FlowNo + "&FK_Node=" + this.NodeID + "&QRCodeRole=2";

                return "url@/CCMobile/MyView.htm?WorkID=" + this.WorkID + "&FK_Flow=" + this.FlowNo + "&FK_Node=" + this.NodeID;
            }
            ...
            if (val == 3)
            {
                ...
                return "url@/CCMobile/MyFlowView.htm?WorkID=" + this.WorkID + "&FK_Flow=" + this.FlowNo + "&FK_Node=" + this.NodeID;
            }
        ...
        /// </summary>
        /// <returns></returns>
        public string ScanGuide_Init_Dict()
        {
            if (DataType.IsNullOrEmpty(WebUser.No) == true)
            {
                BP.WF.Dev2Interface.Port_Login("Guest");
            ...
            return "url@/WF/CCBill/MyDictFrameWork.htm?MethodNo=" + this.GetRequestVal("MethodNo") + "&WorkID=" + this.WorkID + "&FrmID=" + this.FrmID + "&MenuNo=" + this.GetRequestVal("MenuNo") + "&Token=" + token;
        }

        #endregion Vue3 二维码扫描接口
