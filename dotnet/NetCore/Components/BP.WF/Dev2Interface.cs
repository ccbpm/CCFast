    ...
    public class Dev2Interface
    {
        ...
        public static int Todolist_EmpWorks
        {
            get
            {
                ...
                //  ps.SQL = "SELECT  COUNT(WorkID) as Num FROM WF_EmpWorks A WHERE  TaskSta=0 AND A.FK_Emp=" + dbstr + "FK_Emp " + wfSql;
                ps.SQL = "SELECT  COUNT(WorkID) as Num FROM WF_EmpWorks A WHERE   A.FK_Emp=" + dbstr + "FK_Emp " + wfSql;
        ...
        /// 待办待阅数量
        /// </summary>
        public static int Todolist_UnRead
        {
            get
            {
                string userNo = BP.Web.WebUser.No;
        ...
        /// 待办已阅数量
        /// </summary>
        public static int Todolist_Read
        {
            get
            {
                string userNo = BP.Web.WebUser.No;
        ...
        public static int Todolist_CCWorks
        {
            ...
            {
                Paras ps = new Paras();
                ps.SQL = "SELECT count(MyPK) as Num FROM WF_CCList WHERE CCTo=" + BP.Difference.SystemConfig.AppCenterDBVarStr + "FK_Emp";
        ...
        /// 抄送待阅数量
        /// </summary>
        public static int CCList_UnRead
        {
            get
            {
                Paras ps = new Paras();
        ...
        /// 抄送已阅数量
        /// </summary>
        public static int CCList_Read
        {
            get
            {
                Paras ps = new Paras();
                ps.SQL = "SELECT count(MyPK) as Num FROM WF_CCList WHERE CCTo=" + BP.Difference.SystemConfig.AppCenterDBVarStr + "FK_Emp AND Sta=1";
                ps.Add("FK_Emp", BP.Web.WebUser.No);
                return DBAccess.RunSQLReturnValInt(ps, 0);
            }
        }
        ...
        public static int Todolist_OverWorkNum
        {
            get
            {
                ...
                if (BP.Difference.SystemConfig.AppCenterDBType == DBType.MySQL)
                {
                    ...
                    || BP.Difference.SystemConfig.AppCenterDBType == DBType.GBASE8CByOracle)
                {
        ...
        public static int Todolist_Complete
        {
            get
            {
                ...
                Paras ps = new Paras();
                string dbstr = BP.Difference.SystemConfig.AppCenterDBVarStr;
                ps.SQL = "SELECT count(WorkID) Num FROM WF_GenerWorkFlow WHERE (Emps LIKE '%@" + WebUser.No + "@%' OR Emps LIKE '%@" + WebUser.No + ",%' OR Emps LIKE '%," + WebUser.No + "@%') AND (WFState=3 OR WFState=11)";
                return DBAccess.RunSQLReturnValInt(ps, 0);
            }
        }
        /// <summary>
        ...
        public static int MyStart_Complete
        {
            ...
            {
                Paras ps = new Paras();
                ps.SQL = "SELECT count(WorkID) Num FROM WF_GenerWorkFlow WHERE  Starter=" + BP.Difference.SystemConfig.AppCenterDBVarStr + "Starter AND (WFState=3 OR WFState=11 )";
                ps.Add("Starter", WebUser.No);
                return DBAccess.RunSQLReturnValInt(ps, 0);
            }
        }
        ...
        public static DataTable DB_GenerTrackTable(string fk_flow, Int64 workid, Int64 fid, bool isWx = false)
        {
            ...
            if (isWx)
            {
                if (SystemConfig.AppCenterDBType == DBType.Oracle || BP.Difference.SystemConfig.AppCenterDBType == DBType.GBASE8CByOracle)
                {
        ...
        public static DataTable DB_CCList(string domain = null, string fk_flow = null)
        {
            ...
            if (domain == null)
            {
                if (fk_flow == null)
                {
                    ps.SQL = "SELECT a.MyPK,A.Title,A.FlowNo as FK_Flow,A.FlowName,A.WorkID,'' as Doc,A.RecEmpNo as Rec,A.RecEmpName as RecName,A.RDT,A.FID,A.NodeIDCC AS FK_Node,A.NodeIDCCName AS NodeName,B.WFSta,A.Sta,A.NodeIDCC,A.NodeIDCCName FROM WF_CCList A, WF_GenerWorkFlow B WHERE A.CCTo=" + BP.Difference.SystemConfig.AppCenterDBVarStr + "CCTo AND B.WorkID=A.WorkID AND A.Sta >=0  ORDER BY RDT DESC ";
                    ps.Add("CCTo", WebUser.No);
                }
                else
                {
                    ps.SQL = "SELECT a.MyPK,A.Title,A.FlowNo as FK_Flow,A.FlowName,A.WorkID,'' as Doc,A.RecEmpNo as Rec ,A.RecEmpName as RecName,A.RDT,A.FID,A.NodeIDCC AS FK_Node,A.NodeIDCCName AS NodeName,B.WFSta,A.Sta,A.NodeIDCC,A.NodeIDCCName FROM WF_CCList A, WF_GenerWorkFlow B WHERE A.CCTo=" + BP.Difference.SystemConfig.AppCenterDBVarStr + "CCTo  AND B.FK_Flow=" + BP.Difference.SystemConfig.AppCenterDBVarStr + "FK_Flow AND B.WorkID=A.WorkID AND A.Sta >=0 ORDER BY RDT DESC ";
                    ps.Add("CCTo", WebUser.No);
            ...
            else
            {
                if (fk_flow == null)
                {
                    ps.SQL = "SELECT a.MyPK,A.Title,A.FlowNo as FK_Flow,A.FlowName,A.WorkID,'' as Doc,A.RecEmpNo as Rec,A.RecEmpName as RecName,A.RDT,A.FID,A.NodeIDCC AS FK_Node,A.NodeIDCCName AS NodeName,B.WFSta,A.Sta,A.NodeIDCC,A.NodeIDCCName FROM WF_CCList A, WF_GenerWorkFlow B WHERE A.CCTo=" + BP.Difference.SystemConfig.AppCenterDBVarStr + "CCTo AND B.WorkID=A.WorkID AND B.DomainExt=" + BP.Difference.SystemConfig.AppCenterDBVarStr + "DomainExt AND A.Sta >=0 ORDER BY RDT DESC ";
                    ps.Add("CCTo", WebUser.No);
                    ps.Add("DomainExt", domain);
                }
                else
                {
                    ps.SQL = "SELECT a.MyPK,A.Title,A.FlowNo as FK_Flow,A.FlowName,A.WorkID,'' as Doc,A.RecEmpNo as Rec,A.RecEmpName as RecName,A.RDT,A.FID,A.NodeIDCC AS FK_Node,A.NodeIDCCName AS NodeName,B.WFSta,A.Sta,A.NodeIDCC,A.NodeIDCCName FROM WF_CCList A, WF_GenerWorkFlow B WHERE A.CCTo=" + BP.Difference.SystemConfig.AppCenterDBVarStr + "CCTo AND B.WorkID=A.WorkID AND B.FK_Flow=" + BP.Difference.SystemConfig.AppCenterDBVarStr + "FK_Flow AND B.DomainExt=" + BP.Difference.SystemConfig.AppCenterDBVarStr + "DomainExt AND A.Sta >=0 ORDER BY RDT DESC ";
                    ps.Add("CCTo", WebUser.No);
                    ps.Add("DomainExt", domain);
                    ps.Add("FK_Flow", fk_flow);
                }
            ...
            if (BP.Difference.SystemConfig.AppCenterDBFieldCaseModel == FieldCaseModel.UpperCase)
            {
                ...
                dt.Columns["NODEIDCC"].ColumnName = "NodeIDCC";
                dt.Columns["NODEIDCCNAME"].ColumnName = "NodeIDCCName";
            }
            if (BP.Difference.SystemConfig.AppCenterDBFieldCaseModel == FieldCaseModel.Lowercase)
            {
                dt.Columns["mypk"].ColumnName = "MyPK";
        ...
        public static DataTable DB_CCList(CCSta sta, string domain = null, string fk_flow = null)
        {
            ...
            else
            {
                if (fk_flow == null)
                {
                    ps.SQL = "SELECT * FROM WF_CCList WHERE Sta=" + dbStr + "Sta AND CCTo=" + dbStr + "CCTo AND DomainExt=" + dbStr + "DomainExt  ORDER BY RDT DESC";
                    ps.Add("Sta", (int)sta);
                    ps.Add("CCTo", WebUser.No);
                    ps.Add("DomainExt", domain);
                }
                ...
                {
                    ps.SQL = "SELECT * FROM WF_CCList WHERE Sta=" + dbStr + "Sta AND CCTo=" + dbStr + "CCTo AND DomainExt=" + dbStr + "DomainExt AND FK_Flow=" + dbStr + "FK_Flow  ORDER BY RDT DESC";
                    ps.Add("Sta", (int)sta);
                    ps.Add("CCTo", WebUser.No);
                    ps.Add("DomainExt", domain);
                    ps.Add("FK_Flow", fk_flow);
            ...
            if (BP.Difference.SystemConfig.AppCenterDBFieldCaseModel == FieldCaseModel.UpperCase)
            {
                ...
                dt.Columns["FLOWNAME"].ColumnName = "FlowName";
                dt.Columns["NODENAME"].ColumnName = "NodeName";
                dt.Columns["NODEIDWORK"].ColumnName = "NodeIDWork";
                dt.Columns["WORKID"].ColumnName = "WorkID";
                //dt.Columns["DOC"].ColumnName = "Doc";
                dt.Columns["RECEMPNO"].ColumnName = "RecEmpNo";
                dt.Columns["RECEMPNAME"].ColumnName = "RecEmpName";
                dt.Columns["RDT"].ColumnName = "RDT";
                dt.Columns["FID"].ColumnName = "FID";
                dt.Columns["NODEIDCC"].ColumnName = "NodeIDCC";
                dt.Columns["NODEIDCCNAME"].ColumnName = "NodeIDCCName";
        ...
        public static DataTable DB_StarFlows(string userNo, string domain = null)
        {
            ...
            if (BP.Difference.SystemConfig.AppCenterDBFieldCaseModel == FieldCaseModel.UpperCase)
            {
                ...
                if (dt.Columns.Contains("DOMAINEXT"))
                    dt.Columns["DOMAINEXT"].ColumnName = "DomainExt";
                ...
                dt.Columns["FLOWMARK"].ColumnName = "FlowMark";
        ...
        /// <returns></returns>
        public static DataTable DB_WorkFlows()
        {
            DataTable dt = DB_AllFlows();
            if (BP.Difference.SystemConfig.AppCenterDBFieldCaseModel == FieldCaseModel.UpperCase)
            {
                dt.Columns["NO"].ColumnName = "No";
                dt.Columns["NAME"].ColumnName = "Name";
                ...
                dt.Columns["ICON"].ColumnName = "Icon";
                dt.Columns["FK_FLOWSORT"].ColumnName = "FK_FlowSort";
                dt.Columns["ISCANSTART"].ColumnName = "ISCanStart";
                dt.Columns["FK_FLOWSORTTEXT"].ColumnName = "FK_FlowSortText";
                dt.Columns["DOMAIN"].ColumnName = "DomainExt";
        ...
        /// <param name=""></param>
        /// <returns></returns>
        public static DataTable DB_AllFlows(string domain = null)
        {
            string sql = "SELECT A.No,A.Name,A.IsBatchStart,A.Icon,A.FK_FlowSort,A.ISCanStart,B.Name AS FK_FlowSortText,B.ParentNo,B.OrgNo,B.DomainExt,B.MobileColorType,A.IsStartInMobile,A.Idx,A.WorkModel";
            sql += " FROM WF_Flow A, WF_FlowSort B ";
            sql += " WHERE A.FK_FlowSort=B.No ";
        ...
        public static DataTable DB_Start(string userNo = null, string domain = null)
        {
            ...
            if (SystemConfig.CCBPMRunModel == CCBPMRunModel.GroupInc)
            {
                ...
                //分享给指定组织的流程.
                sql6 = "SELECT A.No,A.Name,A.IsBatchStart,A.Icon,A.FK_FlowSort,C.Name AS FK_FlowSortText,C.DomainExt,C.MobileColorType,A.IsStartInMobile,A.Idx,A.WorkModel,C.Idx AS SortIdx,A.FlowMark  FROM WF_Flow A,WF_FlowOrg B,WF_FlowSort C WHERE A.No=B.FlowNo AND A.FK_FlowSort=C.No AND A.ShareSln=2 AND B.OrgNo ='" + WebUser.OrgNo + "' ";

                //其他组织分享的给所有组织的流程..
                sql7 = "SELECT A.No,A.Name,A.IsBatchStart,A.Icon,A.FK_FlowSort,C.Name AS FK_FlowSortText,C.DomainExt,C.MobileColorType,A.IsStartInMobile,A.Idx,A.WorkModel,C.Idx AS SortIdx ,A.FlowMark FROM WF_Flow A,WF_FlowSort C WHERE A.FK_FlowSort=C.No AND A.ShareSln=1 AND A.OrgNo !='" + WebUser.OrgNo + "' ";
        ...
        public static DataTable DB_GenerDraftDataTable(string flowNo = null, string domain = null)
        {
            ...
            else
            {
                if (flowNo == null)
                {
                    ...
                    ps.Add(GenerWorkFlowAttr.Starter, BP.Web.WebUser.No);
                    ps.Add(GenerWorkFlowAttr.DomainExt, domain);
                }
                else
                {
        ...
        public static DataTable DB_Focus(string flowNo = null, string userNo = null, string domain = null)
        {
            ...
            {
                ps.SQL = "SELECT * FROM WF_GenerWorkFlow WHERE AtPara LIKE  '%F_" + userNo + "=1%' AND FK_Flow=" + BP.Difference.SystemConfig.AppCenterDBVarStr + "FK_Flow AND  DomainExt=" + BP.Difference.SystemConfig.AppCenterDBVarStr + "DomainExt";
                ps.Add("FK_Flow", flowNo);
                ps.Add("DomainExt", domain);
            }
        ...
        private static DataTable DB_GenerEmpWorksOfDataTable_AddFrmBill(DataTable dt, string userNo)
        {

            DataTable dtBill = BP.CCBill.Dev2Interface.DB_Todolist(userNo);
            foreach (DataRow dr in dtBill.Rows)
            {
                DataRow myDR = dt.NewRow();
                myDR["WorkID"] = dr["WorkID"];
                myDR["PRI"] = 0; //优先级.
                myDR["FID"] = 0; //FID.
                myDR["TodoEmpsNum"] = 0; //待办人员数量.
                myDR["TaskSta"] = 0; //任务状态.
                myDR["TodoSta"] = 0; //待办状态.

                myDR["Title"] = dr["Title"];
                myDR["Starter"] = dr["Starter"];
                myDR["StarterName"] = dr["StarterName"];
                myDR["WFState"] = dr["BillState"];
                myDR["FK_Flow"] = dr["FrmID"];
                myDR["FlowName"] = dr["FrmName"];

                myDR["FK_Node"] = 0;// dr["FrmID"];
                myDR["NodeName"] = dr["FrmName"];
                //  myDR["RDT"] = dr["RDT"];
                myDR["TodoEmps"] = dr["EmpNo"];
                myDR["BillNo"] = dr["BillNo"];
                myDR["SDTOfNode"] = dr["SDTOfNode"];
                myDR["SysType"] = "FrmBill";

                myDR["FK_Dept"] = dr["DeptNo"];
                myDR["DeptName"] = dr["DeptName"];
                myDR["RDT"] = dr["RDT"];
                myDR["AtPara"] = dr["AtPara"];

                myDR["Sender"] = dr["Sender"];
                myDR["SendDT"] = dr["SendDT"]; //接受日期.
                myDR["ADT"] = dr["SendDT"]; //接受日期.
                dt.Rows.Add(myDR);
            }
            return dt;
        }
        ...
        /// <returns></returns>
        private static DataTable DB_GenerEmpWorksOfDataTable_ExtFlowNo(string userNo, string flowNo, string orderBy = "ADT")
        {
            Flow flow = new Flow(flowNo);
            //   string sql = "SELECT * FROM "+flow.PTable +" WHERE  Emps LIKE '%"+userNo+"%' ";
            // string sql = "SELECT * FROM " + flow.PTable + " WHERE  TodoEmps LIKE '%" + userNo + "%' AND WFState IN (2,5) ORDER BY RDT DESC ";
            string dbStr = SystemConfig.AppCenterDBVarStr;
            Paras ps = new Paras();
            ps.SQL = "SELECT A.*, C.IsRead, C.RDT AS ADT, B.RDT, C.SDT, B.Sender FROM " + flow.PTable + " A, WF_GenerWorkFlow B, WF_GenerWorkerList C WHERE A.OID=C.WorkID AND  A.OID=B.WorkID AND C.FK_Emp=" + dbStr + "UserNo  AND C.IsPass=0   AND C.WhoExeIt !=1   AND B.WFState NOT IN (0,1,3) ";
            ...
            {
                MapAttrs attrs = new MapAttrs("ND" + int.Parse(flow.No) + "Rpt");
                foreach (MapAttr attr in attrs)
                {
                    if (flow.BuessFields.Contains(attr.KeyOfEn) == false)
                        continue;

                    foreach (DataColumn dc in dt.Columns)
                    {
                        if (dc.ColumnName.ToLower().Equals(attr.KeyOfEn.ToLower()) == true)
                        {
                            dc.ColumnName = attr.KeyOfEn;
                            break;
                        }
                    }
                }
            ...
            dt.Columns["OID"].ColumnName = "WorkID";
            return dt;
        }
        /// <summary>
        /// 获取当前人员待处理的工作
            ...
            int nodeID = 0, string wfstate = null, string domain = null, string flowNo = null, string isRead = null, string orderBy = "ADT")
        {
            ...
            {
                int val = DBAccess.RunSQLReturnValInt("SELECT BuessFieldRole FROM WF_Flow WHERE No='" + flowNo + "'", 0);
                if (val == 1)
                    return DB_GenerEmpWorksOfDataTable_ExtFlowNo(userNo, flowNo, orderBy);
            }

            string whereSQL = " ";

            if (DataType.IsNullOrEmpty(domain) == false)
                whereSQL = " AND A.DomainExt='" + domain + "'";
            ...
            {
                if (DBAccess.IsExitsObject("Frm_GenerWorker"))
                    dt = DB_GenerEmpWorksOfDataTable_AddFrmBill(dt, userNo);
            }
            #endregion 加入单据的待办
            return dt;
        ...
        public static DataTable DB_FlowComplete(string userNo, int pageCount, int pageSize, int pageIdx, string strFlow)
        {
            ...
            qo.AddWhere(GenerWorkFlowAttr.FID, 0);
            qo.addAnd();
            qo.AddWhere(GenerWorkFlowAttr.WFState, "IN", "(3,11)"); //结束状态.
            qo.addAnd();
            qo.AddWhere(GenerWorkFlowAttr.Emps, " LIKE ", " '%@" + userNo + "@%'");
            qo.addAnd();
        ...
        /// </summary>
        /// <returns></returns>
        public static GenerWorkFlows DB_Fix()
        {
            GenerWorkFlows gwfs = new GenerWorkFlows();
            QueryObject qo = new QueryObject(gwfs);
            qo.AddWhere("WFState", 9);
            qo.addAnd();
            qo.AddWhere(GenerWorkFlowAttr.TodoEmps, " LIKE ", "%" + WebUser.No + "%");
        ...
        public static DataTable DB_FlowComplete()
        {
            ...
            Paras ps = new Paras();
            string dbstr = BP.Difference.SystemConfig.AppCenterDBVarStr;
            ps.SQL = "SELECT 'RUNNING' AS Type, T.* FROM WF_GenerWorkFlow T WHERE (T.Emps LIKE '%@" + WebUser.No + "@%' OR T.Emps LIKE '%@" + WebUser.No + ",%') AND T.FID=0 AND (T.WFState=3 OR T.WFState=11) ORDER BY  RDT DESC";
            DataTable dt = DBAccess.RunSQLReturnTable(ps);
        ...
        /// 获得确认的待办
        /// </summary>
        /// <param name="isConfim">是否确认的工作？ TRUE=已经确认, false= 未确认.</param>
        /// <returns>返回WF_GenerWorkFlow结构的数据.</returns>
        public static DataTable DB_Todolist_Confim(bool isConfim)
        {

            GenerWorkFlows ens = new GenerWorkFlows();
            QueryObject qo = new QueryObject(ens);
            qo.AddWhere("TodoEmps", " LIKE ", "%@" + WebUser.No + ",%");
            qo.addAnd();

            if (isConfim == true)
                qo.AddWhere("AtPara", " LIKE ", "%@C_" + WebUser.No + "=1@%");
            else
                qo.AddWhere("AtPara", " NOT LIKE ", "%@C_" + WebUser.No + "=1@%");

            qo.addAnd();
            qo.AddWhereIn("WFState", "(2,5)");
            qo.DoQuery();
            return ens.ToDataTableField();
        ...
        public static DataTable DB_FlowComplete2(string fk_flow, string title)
        {
            ...
            if (DataType.IsNullOrEmpty(fk_flow))
            {
                ...
                {
                    ps.SQL = "SELECT 'RUNNING' AS Type,* FROM WF_GenerWorkFlow WHERE Emps LIKE '%@" + WebUser.No + "@%' AND FID=0 AND  (WFState=3 OR WFState=11) and FK_Flow!='010' order by RDT desc";
                }
                else
                {
                    ps.SQL = "SELECT 'RUNNING' AS Type,* FROM WF_GenerWorkFlow WHERE Emps LIKE '%@" + WebUser.No + "@%' and Title Like '%" + title + "%' AND FID=0 AND (WFState=3 OR WFState=11) and FK_Flow!='010' order by RDT desc";
                }
            }
            else
            {
                if (DataType.IsNullOrEmpty(title))
                {
                    ps.SQL = "SELECT 'RUNNING' AS Type,* FROM WF_GenerWorkFlow WHERE Emps LIKE '%@" + WebUser.No + "@%' AND FID=0 AND (WFState=3 OR WFState=11) and FK_Flow='" + fk_flow + "' order by RDT desc";
                }
                else
                {
                    ps.SQL = "SELECT 'RUNNING' AS Type,* FROM WF_GenerWorkFlow WHERE Emps LIKE '%@" + WebUser.No + "@%' and Title Like '%" + title + "%' AND FID=0 AND (WFState=3 OR WFState=11) and FK_Flow='" + fk_flow + "' order by RDT desc";
                }
            }
            return DBAccess.RunSQLReturnTable(ps);
        ...
        {
            string sql = "SELECT A.* FROM WF_GenerWorkFlow A, WF_SelectAccper B WHERE A.WorkID=B.WorkID AND B.FK_Node NOT IN(SELECT FK_Node FROM WF_GenerWorkerList C WHERE C.WorkID=A.WorkID) AND B.FK_Emp='" + WebUser.No + "' AND WFState!=3 AND WFState >1";
        ...
        public static string DB_GenerHungupList(string flowNo = null)
        {
            ...
            qo.addAnd();
            qo.AddWhere(GenerWorkFlowAttr.AtPara, " LIKE ", "'%@Hunguper=" + BP.Web.WebUser.No + "%'");
            if (flowNo != null)
            {
                qo.addAnd();
                qo.AddWhere(GenerWorkFlowAttr.FK_Flow, flowNo);
        ...
        public static DataTable DB_GenerWillReturnNodes_DealDT(DataTable dt, string flowNo)
        {
            ...
            for (int i = 0; i < dt.Rows.Count; i++)
            {
                ...
                string nodeName = dr[1].ToString();
                if (nds.Contains(nodeID + ",") == true)
                    continue;
                nds += nodeID + ",";

                foreach (DataRow mydr1 in mydt.Rows)
                {
                    string nodeID1 = mydr1[1].ToString();
            ...
            switch (nd.HisReturnRole)
            {
                ...
                case ReturnRole.ReturnPreviousNode:
                    ...
                    else
                    {
                        ...
                        if (BP.Difference.SystemConfig.AppCenterDBFieldCaseModel == FieldCaseModel.UpperCase)
                        {
                            mydt.Columns["NO"].ColumnName = "No";
                            mydt.Columns["NAME"].ColumnName = "Name";
                            mydt.Columns["REC"].ColumnName = "Rec";
                            mydt.Columns["RECNAME"].ColumnName = "RecName";
                            mydt.Columns["ISBACKTRACKING"].ColumnName = "IsBackTracking";
                            mydt.Columns["ATPARA"].ColumnName = "AtPara";
                        }
                        ...
                        if (mydt.Rows.Count != 0)
                            return DB_GenerWillReturnNodes_DealDT(mydt, gwf.FlowNo);
                ...
                case ReturnRole.ReturnSpecifiedNodes: //退回指定的节点。
                    ...
                    if (rnds.Count == 0)
                    {
                        ...
                        if (DataType.IsNullOrEmpty(returnNodes) == true)
                            throw new Exception("@流程设计错误，您设置该节点可以退回指定的节点，但是指定的节点集合为空，请在节点属性设置它的指定节点。");
                    ...
                    break;
                case ReturnRole.ReturnStartNode:
                    int startNodeID = Int32.Parse(Int32.Parse(nd.FlowNo) + "01");
                    GenerWorkerList gwll = new GenerWorkerList();
                    int count = gwll.Retrieve(GenerWorkerListAttr.FK_Node, startNodeID, GenerWorkerListAttr.WorkID, workid);
                    if (count == 0)
                        throw new Exception("err@不可能出现的错误，退回到开始节点找不到申请人的处理信息");

                    DataRow drr = dt.NewRow();
                    drr["No"] = gwll.NodeID.ToString();
                    drr["Name"] = gwll.NodeName;
                    drr["Rec"] = gwll.EmpNo;
                    drr["RecName"] = gwll.EmpName;
                    Node mynd1 = new Node(startNodeID);
                    if (mynd1.ItIsBackTracking == true) //是否可以原路返回.
                    {
                        drr["IsBackTracking"] = "1";
                    }
                    else
                    {
                        drr["IsBackTracking"] = "0";
                    }
        ...
        #region 获取当前操作员的在途工作
        private static DataTable DB_RuningExt(string userNo, string flowNo, bool isMyStarter = false, string domain = null, bool isContainFuture = false)
        {
            string dbStr = BP.Difference.SystemConfig.AppCenterDBVarStr;
            Paras ps = new Paras();
            ...
            if (domain != null)
            {
                if (SystemConfig.AppCenterDBType == DBType.DM)
                    domainSQL = " AND A.\"DomainExt\"='" + domain + "' ";
                else
                    domainSQL = " AND A.DomainExt='" + domain + "' ";
            }
            ...
            switch (DBAccess.AppCenterDBType)
            {
                ...
                case DBType.GBASE8CByOracle:
                    currNode = "(SELECT FK_Node FROM (SELECT G.FK_Node FROM WF_GenerWorkFlow A,WF_GenerWorkerlist G WHERE G.WorkID = A.WorkID AND G.FK_Emp='" + userNo + "' " + domainSQL + " Order by G.RDT DESC ) WHERE RowNum=1)";
                    break;
                case DBType.MySQL:
                case DBType.PostgreSQL:
                case DBType.UX:
                case DBType.HGDB:
                    currNode = "(SELECT  FK_Node FROM WF_GenerWorkerlist G WHERE   G.WorkID = A.WorkID AND FK_Emp='" + userNo + "' Order by RDT DESC LIMIT 1)";
                    break;
                case DBType.MSSQL:
                    currNode = "(SELECT TOP 1 FK_Node FROM WF_GenerWorkerlist G WHERE  G.WorkID = A.WorkID AND FK_Emp='" + userNo + "' Order by RDT DESC)";
                    break;
                default:
                    break;
            }
            ...
            if (isContainFuture == true)
            {
                ...
                {
                    case DBType.MySQL:
                        futureSQL = " UNION SELECT A.WorkID,A.StarterName,A.Title,A.DeptName,D.Name AS NodeName,B.FK_Node,A.FK_Flow,A.FlowName,C.EmpName AS TodoEmps," + currNode + " AS CurrNode ,1 AS RunType,A.WFState, 0 AS WhoExeIt,E.* FROM WF_GenerWorkFlow A, WF_SelectAccper B,"
                                + "(SELECT GROUP_CONCAT(B.EmpName SEPARATOR ';') AS EmpName, B.WorkID,B.FK_Node FROM WF_GenerWorkFlow A, WF_SelectAccper B WHERE A.WorkID = B.WorkID  group By B.FK_Node,B.WorkID) C,WF_Node D," + flow.PTable + " E"
                                + " WHERE E.OID=A.WorkID AND E.OID=B.WorkID AND A.WorkID = B.WorkID AND B.WorkID = C.WorkID AND B.FK_Node = C.FK_Node AND A.FK_Node = D.NodeID AND B.FK_Emp = '" + userNo + "' " + domainSQL
                    ...
                    case DBType.MSSQL:
                        futureSQL = " UNION SELECT A.WorkID,A.StarterName,A.Title,A.DeptName,D.Name AS NodeName,B.FK_Node,A.FK_Flow,A.FlowName,C.EmpName AS TodoEmps ," + currNode + " AS CurrNode ,1 AS RunType,A.WFState, 0 AS WhoExeIt,E.* FROM WF_GenerWorkFlow A, WF_SelectAccper B,"
                                + "(SELECT EmpName=STUFF((Select ';'+FK_Emp+','+EmpName From WF_SelectAccper t Where t.FK_Node=B.FK_Node FOR xml path('')) , 1 , 1 , '') , B.WorkID,B.FK_Node FROM WF_GenerWorkFlow A, WF_SelectAccper B WHERE A.WorkID = B.WorkID  group By B.FK_Node,B.WorkID) C,WF_Node D," + flow.PTable + " E"
                                + " WHERE  E.OID=A.WorkID AND E.OID=B.WorkID AND A.WorkID = B.WorkID AND B.WorkID = C.WorkID AND B.FK_Node = C.FK_Node AND A.FK_Node = D.NodeID AND B.FK_Emp = '" + userNo + "' " + domainSQL
                                + " AND B.FK_Node Not in(Select DISTINCT FK_Node From WF_GenerWorkerlist G where G.WorkID = B.WorkID)AND A.WFState NOT IN(0,1,3)";
                        break;
                    default:
            ...
            if (isMyStarter == true)
            {
                sql = "SELECT DISTINCT a.WorkID,a.StarterName,a.Title,a.DeptName,a.NodeName,a.FK_Node,a.FK_Flow,a.FlowName,a.TodoEmps ," + currNode + " AS CurrNode,0 AS RunType,a.WFState, 0 AS WhoExeIt,C.* FROM WF_GenerWorkFlow A, WF_GenerWorkerlist B," + flow.PTable + " C WHERE A.WorkID=C.OID AND B.WorkID=C.OID AND  A.WFState >=2 AND  A.TodoEmps  not like '%" + WebUser.No + ",%' AND  A.FK_Flow=" + dbStr + "FK_Flow  AND A.WorkID=B.WorkID AND B.FK_Emp=" + dbStr + "FK_Emp AND B.IsEnable=1 AND B.IsPass != -2 AND  (B.IsPass=1 or B.IsPass < -1 ) AND  A.Starter=" + dbStr + "Starter AND A.WFState NOT IN ( 0, 1, 3 )";
                sql += Check_CCBPMRunModel();
                if (isContainFuture == true)
                {
                    sql += futureSQL;
                }
                sql += " UNION SELECT DISTINCT a.WorkID,a.StarterName,a.Title,a.DeptName,a.NodeName,a.FK_Node,a.FK_Flow,a.FlowName,a.TodoEmps,A.FK_Node AS CurrNode,0 AS RunType,a.WFState, 1 AS WhoExeIt,D.*  FROM WF_GenerWorkFlow A, WF_GenerWorkerlist B,WF_Node C," + flow.PTable + " D WHERE A.WorkID=D.OID AND B.WorkID=D.OID AND  A.WFState >=2 AND  A.FK_Flow=" + dbStr + "FK_Flow AND A.WorkID=B.WorkID AND A.FK_Node=C.NodeID AND B.FK_Node=C.NodeID AND C.WhoExeIt=0 AND B.FK_Emp=" + dbStr + "FK_Emp AND B.IsEnable=1 AND B.IsPass = 0 AND B.WhoExeIt=1 AND  A.Starter=" + dbStr + "Starter AND A.WFState NOT IN ( 0, 1, 3 )";
                ps.SQL = sql;
                sql += Check_CCBPMRunModel();
                ps.Add("FK_Flow", flowNo);
                ps.Add("FK_Emp", userNo);
            ...
            bool isMyStarter = false, string domain = null, bool isContainFuture = false)
        {
            ...
            {
                int val = DBAccess.RunSQLReturnValInt("SELECT BuessFieldRole FROM WF_Flow WHERE No='" + fk_flow + "'", 0);
                if (val == 1)
                    return DB_RuningExt(userNo, fk_flow, isMyStarter, domain, isContainFuture);
            }
            ...
            if (DataType.IsNullOrEmpty(fk_flow))
            {
                if (isMyStarter == true)
                {
                    sql = "SELECT DISTINCT a.WorkID,a.Starter,a.StarterName,a.Title,a.DeptName,a.NodeName,a.RDT,a.FK_Node,a.FK_Flow,a.FID ,a.FlowName,a.TodoEmps," + currNode + " AS CurrNode,0 AS RunType,a.WFState, 0 AS WhoExeIt FROM WF_GenerWorkFlow A, WF_GenerWorkerlist B WHERE A.WFState >=2 AND A.TodoEmps  not like '%" + WebUser.No + ",%' AND  A.WorkID=B.WorkID AND B.FK_Emp=" + dbStr + "FK_Emp AND B.IsEnable=1 AND B.IsPass != -2 AND   (B.IsPass=1 or B.IsPass < -1) AND  A.Starter=" + dbStr + "Starter AND A.WFState NOT IN ( 0, 1, 3 )";
                    sql += Check_CCBPMRunModel();
                    if (isContainFuture == true)
                    {
                        sql += futureSQL;
                    }
                    sql += " UNION SELECT DISTINCT a.WorkID,a.Starter,a.StarterName,a.Title,a.DeptName,a.NodeName,a.RDT,a.FK_Node,a.FK_Flow,a.FID ,a.FlowName,a.TodoEmps,A.FK_Node AS CurrNode,0 AS RunType,a.WFState, 1 AS WhoExeIt FROM WF_GenerWorkFlow A, WF_GenerWorkerlist B,WF_Node C WHERE  A.WFState >=2 AND A.WorkID=B.WorkID AND A.FK_Node=C.NodeID AND B.FK_Node=C.NodeID AND C.WhoExeIt=0 AND B.FK_Emp=" + dbStr + "FK_Emp AND B.IsEnable=1 AND B.IsPass = 0 AND B.WhoExeIt=1 AND  A.Starter=" + dbStr + "Starter AND A.WFState NOT IN ( 0, 1, 3 )";
                    sql += Check_CCBPMRunModel();
                    ps.SQL = sql;
                    ps.Add("FK_Emp", userNo);
                    ps.Add("Starter", userNo);
            ...
            else
            {
                if (isMyStarter == true)
                {
                    ...
                    sql += " UNION SELECT DISTINCT a.WorkID,a.Starter,a.StarterName,a.Title,a.DeptName,a.NodeName,a.RDT,a.FK_Node,a.FK_Flow,a.FID ,a.FlowName,a.TodoEmps,A.FK_Node AS CurrNode,0 AS RunType,a.WFState, 1 AS WhoExeIt FROM WF_GenerWorkFlow A, WF_GenerWorkerlist B,WF_Node C WHERE  A.WFState >=2 AND  A.FK_Flow=" + dbStr + "FK_Flow AND A.WorkID=B.WorkID AND A.FK_Node=C.NodeID AND B.FK_Node=C.NodeID AND C.WhoExeIt=0 AND B.FK_Emp=" + dbStr + "FK_Emp AND B.IsEnable=1 AND B.IsPass = 0 AND B.WhoExeIt=1 AND  A.Starter=" + dbStr + "Starter AND A.WFState NOT IN ( 0, 1, 3 )";
                    sql += Check_CCBPMRunModel();
                    ps.SQL = sql;
                    ps.Add("FK_Flow", fk_flow);
                    ps.Add("FK_Emp", userNo);
            ...
            if (DataType.IsNullOrEmpty(deptNo) == true && DataType.IsNullOrEmpty(orgNo) == true)
            {
                if (DataType.IsNullOrEmpty(emp.DeptNo) == true)
                {
                    ...
                    if (DataType.IsNullOrEmpty(deptNo) == true)
                        throw new Exception("err@用户[" + emp.No + "]没有部门，无法登录.");
                    emp.DeptNo = deptNo;
                    WebUser.SignInOfGener(emp, "CH", false, false, null, null, isSSO);
                    return;
                }
            ...
            if (DataType.IsNullOrEmpty(deptNo) == false)
            {
                if (emp.DeptNo.Equals(deptNo) == false)
                {
                    ...
                    if (DBAccess.RunSQLReturnValInt(sql) == 0)
                        throw new Exception("err@用户[" + emp.No + "]不在部门[" + deptNo + "]，无法登录.");
                }
                emp.DeptNo = deptNo;
                WebUser.SignInOfGener(emp, "CH", false, false, null, null, isSSO);
                return;
        ...
        {
            if (DataType.IsNullOrEmpty(token) == true)
                throw new Exception("err@传入的Token值为空.");
            if (SystemConfig.TokenModel == 1)
            {
                if (logDev == null)
                    logDev = "PC";
	     ...
	     * 判断是否第一次登录
	     */
        private static void Port_ExcuteFirstLogin()
        {
            ...
            WebUser.IsFirstLogin = false;
            if (!isExist && SystemConfig.IsPassWordChangeBYFirstLogin == true)
            {
        ...
        private static string Port_GenerToken_2021(string userNo, string logDev = "PC", int activeMinutes = 0, bool isGenerNewToken = false)
        {
            ...
            if (isGenerNewToken == true || DataType.IsNullOrEmpty(myGuid) == true || DataType.IsNullOrEmpty(guidOID_Dt) == true)
            {
                ...
                emp.Update();
                WebUser.Token = guid;
                if (SystemConfig.IsPassWordChangeBYFirstLogin == true)
                {
                    WebUser.IsFirstLogin = true;
                }
                return guid;
            ...
            string sendEmpNo, string openUrl, string pushModel, Int64 workID, string msgPK = null, string atParas = null)
        {
            ...
            foreach (string item in arrEmp)
            {
                ...
                try
                {
                    if (SystemConfig.CCBPMRunModel == CCBPMRunModel.SAAS)
                    {
                        emp = new BP.Port.Emp(WebUser.OrgNo + "_" + item);
                    }
                    else
                    {
        ...
        public static string WriteTrack(string flowNo, int nodeFromID, string nodeFromName, Int64 workid, Int64 fid, string msg, ActionType at, string tag,
            string cFlowInfo, string writeImg, string optionMsg = null, string empNoTo = null, string empNameTo = null, string empNoFrom = null, string empNameFrom = null, string rdt = null, string fwcView = null, string nodeData = null)
        {
        ...
        /// <param name="fid">fID</param>
        /// <param name="msg">信息</param>
        public static string WriteTrackInfo(string flowNo, int nodeFrom, string ndFromName, Int64 workid, Int64 fid, string msg, string optionMsg)
        {
        ...
        public static void Node_WriteWorkCheck(Int64 workid, string msg, string optionName, string writeImg, string fwcView = null, string checkTime = "")
        {
            string dbStr = BP.Difference.SystemConfig.AppCenterDBVarStr;
            ...
            if (DataType.IsNullOrEmpty(checkTime))
            ...
            if (num > 1 || (num == 1 && DataType.IsNullOrEmpty(fwcView) == false))
            {
                ps.Clear();
        ...
        public static void WriteTrackGovDoc(string flowNo, int nodeFrom, string nodeFromName, Int64 workid, Int64 fid, string msg, byte[] bytes)
        {
            ...
            //保存文件到数据库.
            DBAccess.SaveBytesToDB(bytes, table, "MyPK", val, "DBFile");
        }
        /// <summary>
        ...
        public static string GetCheckRDT(string flowNo, Int64 workId, int nodeFrom, string empFrom)
        {
            string table = "ND" + int.Parse(flowNo) + "Track";
            string sql = "SELECT RDT FROM " + table + " WHERE NDFrom=" + nodeFrom + " AND ActionType=" + (int)ActionType.WorkCheck + " AND EmpFrom='" + empFrom + "' AND WorkID=" + workId + " ORDER BY RDT DESC ";
            DataTable dt = DBAccess.RunSQLReturnTable(sql);
            if (dt.Rows.Count == 0)
            {
                return "";
        ...
        public static void SetParentInfo(string subFlowNo, Int64 subFlowWorkID, Int64 parentWorkID, bool isCopyData = false)
        {
            //创建父流程.
            ...
            ps.Add(GenerWorkFlowAttr.PEmp, WebUser.No);
            ...
            ps.Add(GERptAttr.PEmp, WebUser.No);
            ...
            if (fnsFrom.Count != 0)
            {
                ...
                if (fns.Count != 0)
                {
                    ...
                    foreach (FrmNode fn in fns)
                    {
                        ...
                        {
                            if (fn.FrmID.Equals(fnFrom.FrmID) == false)
                                continue;

                            BP.Sys.GEEntityOID geEnFrom = new GEEntityOID(fnFrom.FrmID);
        ...
        public static string Flow_DoRebackWorkFlow(string flowNo, Int64 workid, int backToNodeID, string note, string empNo = "")
        {
        ...
        /// 执行批量移交
        /// </summary>
        /// <param name="fromOneUserNo">当事人的人员账号</param>
        /// <param name="workIDs">流程实例编号，多个用逗号分开.</param>
        /// <param name="toOneUserNo">移交给的人员编号.</param>
        /// <returns>执行信息</returns>
        public static string Flow_Batch_Shift(string fromOneUserNo, string workIDs, string toOneUserNo)
        {

            string[] splitWorkID = workIDs.Split(",");
            foreach (string item in splitWorkID)
            {
                Int64 workid = int.Parse(item);
                BP.WF.Dev2Interface.Node_Shift(fromOneUserNo, workid, toOneUserNo, "批量移交.");
            }
            ...
            return "执行成功, 合计 : 待办 " + splitWorkID.Length + " 个, 未来处理待办 " + dt.Rows.Count + " 个, 数据被移交给 [" + toOneUserNo + "]";
        }
        ...
        /// <returns>返回成功执行信息</returns>
        public static string Flow_DoFlowOver(Int64 workID, string msg, WFState wfState = WFState.CompleteEnd)
        {
            WorkFlow wf = new WorkFlow(workID);
            ...
            // msg = wf.DoFlowOver(ActionType.FlowOver, msg, nd, rpt, WFState.Complete);
        ...
        public static bool Flow_CheckFlowIsOver(Int64 workID)
        {
            GenerWorkFlow gwf = new GenerWorkFlow(workID);
            if (gwf.IsOver == true)
                return true;
        ...
        /// <param name="workID"></param>
        /// <returns></returns>
        public static bool Flow_IsHaveDocFile(Int64 workID)
        {
            GenerWorkFlow gwf = new GenerWorkFlow(workID);
            Node nd = new Node(gwf.NodeID);

            string refPk = nd.NodeFrmID + "_GovAth";
        ...
        public static string Flow_DoPress(Int64 workID, string msg, bool isPressSubFlow = false)
        {
            ...
            //pms.Retrieve(PushMsgAttr.NodeID, gwf.NodeID,
            //    PushMsgAttr.EventNo, EventListNode.PressAfter);
            ...
            foreach (GenerWorkerList wl in wls)
            {
                ...
                BP.WF.Dev2Interface.Port_SendMsg(wl.EmpNo, mailTitle, msg, null, BP.WF.SMSMsgType.DoPress, gwf.FlowNo, gwf.NodeID, gwf.WorkID, gwf.FID, model);
        ...
        {
            DBAccess.RunSQLReturnString("UPDATE WF_GenerWorkFlow SET SDTOfFlow='" + sdt + "' WHERE WorkID=" + workid);
        }
        /// <summary>
        /// 设置流程标题
        /// </summary>
        ...
        public static Int64 Flow_StartAsWorkID(Int64 workid_History)
        {
            ...
            {
                //2. 查询数据.
                GEEntityOID ge = new GEEntityOID("ND" + rpt.FlowEndNode);
            ...
            foreach (FrmNode fn in fns)
            {
                ...
                //2. 查询数据.
                GEEntityOID ge = new GEEntityOID(fn.FrmID);
                ge.OID = workid_History;
        ...
        public static string Flow_ReSend(Int64 workid, int toNodeID, string toEmpIDs, string note)
        {
            ...
            if (num == 0) return "err@需要调整到的人员不能无效";
            if(num>1 && nd.ItIsStartNode) return "err@流程调整到开始节点，只能选择一个处理人";
            #endregion 处理要调整到的人员
            ...
            int jumpToNode = 0, string jumpToEmp = null, string todoEmps = null, string isStartSameLevelFlow = null)
        {
            ...
            {
                ht = new Hashtable();
                ht.Add(StartFlowParaNameList.PWorkID, parentWorkID);
                ht.Add(StartFlowParaNameList.PFID, parentFID);
                ht.Add(StartFlowParaNameList.PFlowNo, parentFlowNo);
                ht.Add(StartFlowParaNameList.PNodeID, parentNodeID);
                if (DataType.IsNullOrEmpty(parentEmp))
                    parentEmp = WebUser.No;
                ht.Add(StartFlowParaNameList.PEmp, parentEmp);
            }
            ...
            if (BP.Difference.SystemConfig.AppCenterDBType == DBType.DM)
                DBAccess.RunSQL("UPDATE WF_GenerWorkFlow  SET DomainExt=(SELECT DomainExt FROM WF_FlowSort WHERE WF_FlowSort.No=WF_GenerWorkFlow.FK_FlowSort) WHERE WorkID=" + wk.OID);
            else
                DBAccess.RunSQL("UPDATE WF_GenerWorkFlow  SET DomainExt=(SELECT DomainExt FROM WF_FlowSort WHERE WF_FlowSort.No=WF_GenerWorkFlow.FK_FlowSort) WHERE WorkID=" + wk.OID);
...
#warning 增加是防止手动启动子流程或者平级子流程时关闭子流程页面找不到待办 保存到待办。
        ...
        public static void Node_RemoveTodolist(long workid, String empNo)
        {
            GenerWorkFlow gwf = new GenerWorkFlow(workid);
            if (gwf.IsOver == true)
                throw new Exception("流程：" + gwf.Title + "已经完成,您不能移除接受人.");

            GenerWorkerLists gwls = new GenerWorkerLists();
            gwls.Retrieve(GenerWorkerListAttr.WorkID, workid, GenerWorkerListAttr.FK_Node, gwf.NodeID, GenerWorkerListAttr.IsPass, 0);
            if (gwls.Count == 1)
                throw new Exception("err@当前的节点未处理的待办人员只有一个，不能移除");

            //删除当前人员
            GenerWorkerList gwl = new GenerWorkerList();
            gwl.Delete(GenerWorkerListAttr.WorkID, workid, GenerWorkerListAttr.FK_Node, gwf.NodeID, GenerWorkerListAttr.FK_Emp, empNo);
        ...
        /// 执行工作发送
        /// </summary>
        /// <param name="flowNo">工作编号</param>
        /// <param name="workID">工作ID</param>
        /// <param name="ht">节点表单数据</param>
        /// <param name="dsDtl">节点表单从表数据</param>
        /// <returns>返回发送结果</returns>
        public static SendReturnObjs Node_SendWork(string flowNo, Int64 workID, Hashtable ht = null, DataSet dsDtl = null)
        {
            return Node_SendWork(flowNo, workID, ht, dsDtl, 0, null);
        }
        /// <summary>
        /// 发送工作
        /// </summary>
        /// <param name="flowNo">流程编号</param>
        /// <param name="workID">工作ID</param>
        /// <param name="toNodeID">发送到的节点编号，如果是0就让ccflow方向条件自动计算.</param>
        /// <param name="toEmps">发送到的人员,多个人员用逗号分开比如：zhangsan,lisi. 如果是null则表示让ccflow自动计算.</param>
        /// <returns>返回执行信息</returns>
        public static SendReturnObjs Node_SendWork(string flowNo, Int64 workID, int toNodeID, string toEmps)
        {
            return Node_SendWork(flowNo, workID, null, null, toNodeID, toEmps);
        }
        /// <summary>
        /// 发送工作
        /// </summary>
        ...
        /// <param name="toNodeID">到达的节点：可以为0,如果是0就让ccflow方向条件自动计算.<</param>
        /// <param name="nextWorkers">接收人,格式:zhangsan,lisi  可以为空.如果是null则表示让ccflow自动计算.</param>
        /// <returns>执行信息</returns>
        public static SendReturnObjs Node_SendWork(string flowNo, Int64 workID,
            Hashtable htWork, int toNodeID, string nextWorkers)
        {
            return Node_SendWork(flowNo, workID, htWork, null, toNodeID, nextWorkers, WebUser.No, WebUser.Name, WebUser.DeptNo, WebUser.DeptName, null, 0, 0);
        }
        /// <summary>
        /// 发送工作
        /// </summary>
        ...
        public static string Node_CC_SetCheckOverBatch(string workids, string checkInfo = null)
        {
            ...
            foreach (string id in ids)
            {
                ...
                foreach (FrmNode fn in fns)
                {
                    if (fn.FrmID.Equals("ND" + gwf.NodeID) == true)
                        continue;
        ...
        public static string Node_SaveWork(Int64 workID, Hashtable htWork, DataSet dsDtls = null, DataSet dsAths = null)
        {
            ...
            try
            {
                    ...
                    foreach (DataTable dt in dsAths.Tables)
                    {
                        foreach (FrmAttachment ath in wk.HisFrmAttachments)
                        {
                            if (dt.TableName.Equals(ath.NoOfObj) == false)
                                continue;
                            if (ath.FrmID.Equals(nd.NodeFrmID) == false)
                                continue;
                ...
                string titleRoleNodes = "";
                if (nd.ItIsStartNode)
                    titleRoleNodes = nd.NodeID.ToString();
                if (DataType.IsNullOrEmpty(titleRoleNodes) == true)
                    titleRoleNodes = DBAccess.RunSQLReturnString("SELECT TitleRoleNodes FROM WF_Flow WHERE No='" + gwf.FlowNo + "' "); // fl.TitleRoleNodes;
                ...
                #region 草稿规则.
                if (nd.ItIsStartNode && gwf.WFState == WFState.Blank)
                {
                    int draft = DBAccess.RunSQLReturnValInt("SELECT Draft FROM WF_Flow WHERE No='" + gwf.FlowNo + "' ");
        ...
        {
            return Node_Shift(WebUser.No, workID, toEmps, msg);
        }
        ...
        public static string Node_Shift(string fromUser, Int64 workID, string toEmps, string msg)
        {
            if (DataType.IsNullOrEmpty(toEmps) == true)
        ...
        /// <param name="returnToEmp">退回到人员,如果是null，就退回给指定节点的处理人，标记:退回当前节点的所有人：AllEmps </param>
            ...
            bool isKillEtcThread = true)
        {
            ...
            if (DataType.IsNullOrEmpty(returnToEmp) == false)
            {
                ...
                sql = "SELECT WorkID,FK_Emp,EmpName FROM WF_GenerWorkerlist WHERE WorkID=" + workID + " AND FK_Node=" + returnToNodeID;
            dt = DBAccess.RunSQLReturnTable(sql);
            if (dt.Rows.Count == 0)
            {
                // 有可能是父流程.  @lizhen
                ...
                string empNo = dt.Rows[0].ToString();
                string empName = dt.Rows[2].ToString();
                string deptNo = dt.Rows[3].ToString();
                ...
                sql = "UPDATE  WF_GenerWorkerlist SET IsPass=0,IsRead=0,RDT='" + DataType.CurrentDateTimess + "' WHERE  FK_Emp='" + empNo + "' AND  WorkID=" + gwf.PWorkID + " AND FK_Node=" + gwf.PNodeID;
                ...
                return "已经退回给父流程“" + gwfP.FlowName + "”节点“" + gwfP.NodeName + "”，退回给“" + empName + "”";
            }
        ...
        public static string GetAthRefPKVal(Int64 workid, Int64 pworkid, Int64 fid, int fk_node, string fk_mapData, FrmAttachment athDesc)
        {
            ...
            {
                if (nd.ItIsSubThread == false && fid != 0)
                    pkval = fid;
                else
                    pkval = workid;
            }
        ...
        /// <param name="NodeID"></param>
        /// <returns></returns>
        public static Nodes GetPreplaceWokerFreeNodes(Int64 WorkID, string FlowNo, int NodeID)
        {
        ...
        public static Nodes NodeSend_GenerNextStepNode_Ext(Node node, Nodes nodes, string FlowNo, long WorkID)
        {
            Directions dirs = new Directions();
            dirs.Retrieve(DirectionAttr.Node, node.NodeID, "Idx");
            if (dirs.Count == 1)
            {
                Direction d = (Direction)dirs[0];
                Node nd = new Node(d.ToNode);
                nodes.AddEntity(nd); //把他加入到里面.
                return nodes = NodeSend_GenerNextStepNode_Ext(nd, nodes, FlowNo, WorkID);
            }
            else
            {
                foreach (Direction dir in dirs)
                {
                    //查询出来他的条件.
                    Conds conds = new Conds();
                    conds.Retrieve(CondAttr.FK_Node, node.NodeID, CondAttr.ToNodeID, dir.ToNode, CondAttr.CondType, (int)CondType.Dir, CondAttr.Idx);

                    if (conds.Count == 0)
                        continue;
                    //可以到达的节点.
                    if (conds.Count == 1 && node.HisDeliveryWay == DeliveryWay.PreplaceWokerFree)
                    {
                        Node nd = new Node(dir.ToNode);
                        Hashtable ht = new Hashtable();
                        nodes.AddEntity(nd);
                        continue;
                    }
                    ...
                    webUserCopy.No = WebUser.No;
                    webUserCopy.Name = WebUser.Name;
                    webUserCopy.DeptNo = WebUser.DeptNo;

                    GERpt geRpt = new GERpt("ND" + Int64.Parse(FlowNo) + "Rpt", WorkID);
                    //按条件计算.
                    if (conds.GenerResult(geRpt, webUserCopy, node) == true)
                    {
                        node = new Node(dir.ToNode);
                        if (node.HisNodeType == NodeType.UserNode)
                        {
                            Node nd = new Node(dir.ToNode);
                            nodes.AddEntity(nd);
                            return nodes = NodeSend_GenerNextStepNode_Ext(nd, nodes, FlowNo, WorkID);
