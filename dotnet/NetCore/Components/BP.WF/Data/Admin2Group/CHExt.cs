    ...
    public class CHExt : EntityMyPK
    {
        ...
        public override Map EnMap
        {
            get
            {
                ...
                map.AddTBString(CHAttr.DeptNo, null, "部门", true, true, 0, 900, 5, true);
                map.AddDDLEntities(CHAttr.EmpNo, null, "当事人", new BP.Port.Emps(), false);

                map.AddDDLEntities(CHAttr.FlowNo, null, "流程", new FlowSimples(), false);
                map.AddTBString(CHAttr.Title, null, "标题", true, true, 0, 900, 5, true);
                map.AddTBString(CHAttr.NodeIDT, null, "节点名称", true, true, 0, 50, 5);
                ...
                map.AddSearchAttr(CHAttr.FlowNo);
        ...
        {
            return "../../MyView.htm?FlowNo" + this.FlowNo + "&WorkID=" + this.WorkID + "&OID=" + this.WorkID;
        }
    }
    /// <summary>
    /// 时效考核s
