    ...
    public class CHExt : EntityMyPK
    {
        ...
        public override Map EnMap
        {
            get
            {
                ...
                map.AddMyPK();
                map.AddTBString(CHAttr.DeptNoT, null, "部门", true, true, 0, 900, 5, true);
                ...
                map.AddTBString(CHAttr.EmpNoT, null, "当事人", true, true, 0, 900, 5, true);

                map.AddTBString(CHAttr.Title, null, "标题", true, true, 0, 900, 5, true);
                map.AddTBString(CHAttr.FlowNo, null, "流程编号", true, true, 0, 900, 5, false);
                map.AddTBString(CHAttr.FlowNoT, null, "名称", true, true, 0, 900, 5, false);
