    ...
    public class CHExt : EntityMyPK
    {
        ...
        public override Map EnMap
        {
            get
            {
                ...
                map.AddTBString(CHAttr.FlowNo, null, "流程编号", true, true, 0, 5, 5, true);
                map.AddTBString(CHAttr.FlowNoT, null, "流程名称", true, true, 0, 30, 5, true);

                //  map.AddDDLEntities(CHAttr.FlowNo, null, "流程", new Flows(), false);
                ...
                map.AddDDLEntities(CHAttr.DeptNo, null, "隶属部门", new BP.Port.Depts(), false);
                ...
                //查询条件.
                map.AddSearchAttr(CHAttr.DeptNo);
                map.AddSearchAttr(CHAttr.CHSta);
                map.AddSearchAttr(CHAttr.EmpNo);
