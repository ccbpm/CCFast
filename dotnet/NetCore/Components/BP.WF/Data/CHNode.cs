    ...
    public class CHNode : EntityMyPK
    {
        ...
        public override Map EnMap
        {
            get
            {
                ...
                map.AddTBString(CHAttr.EmpNo, null, "处理人", true, true, 0, 100, 3);
                map.AddTBString(CHAttr.EmpNoT, null, "处理人名称", true, true, 0, 200, 5);
        ...
        {
            this.setMyPK(this.WorkID + "_" + this.GetValStringByKey("NodeID"));
