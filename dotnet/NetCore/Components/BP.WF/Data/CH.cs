...
namespace BP.WF.Data
{
    ...
    public class CHAttr : EntityMyPKAttr
    {
        ...
        /// 流程编号
        /// </summary>
        public const string FlowNoT = "FlowNoT";
        ...
        /// 节点编号
        /// </summary>
        public const string NodeIDT = "NodeIDT";
        ...
        /// 部门编号
        /// </summary>
        public const string DeptNoT = "DeptNoT";
        /// <summary>
        /// 当事人
        /// </summary>
        ...
        /// 当事人名称
        /// </summary>
        public const string EmpNoT = "EmpNoT";
        /// <summary>
        /// 相关当事人
        /// </summary>
    ...
    public class CH : EntityMyPK
    {
        ...
        public string FlowNo
        {
            get
            {
                return this.GetValStringByKey(CHAttr.FlowNo);
            }
            set
            {
                this.SetValByKey(CHAttr.FlowNo, value);
            }
        }
        /// <summary>
        /// 流程
        ...
        public string FlowT
        {
            get
            {
                return this.GetValStringByKey(CHAttr.FlowNoT);
            }
            set
            {
                this.SetValByKey(CHAttr.FlowNoT, value);
            }
        }
        /// <summary>
        /// 限期
        ...
        public string EmpNo
        {
            get
            {
                return this.GetValStringByKey(CHAttr.EmpNo);
            }
            set
            {
                this.SetValByKey(CHAttr.EmpNo, value);
            }
        }
        /// <summary>
        /// 人员
        ...
        public string EmpT
        {
            get
            {
                return this.GetValStringByKey(CHAttr.EmpNoT);
            }
            set
            {
                this.SetValByKey(CHAttr.EmpNoT, value);
            }
        }
        /// <summary>
        /// 相关当事人
        ...
        public string DeptNo
        {
            get
            {
                return this.GetValStrByKey(CHAttr.DeptNo);
            }
            set
            {
                this.SetValByKey(CHAttr.DeptNo, value);
            }
        }
        /// <summary>
        /// 部门名称
        ...
        public string DeptT
        {
            get
            {
                return this.GetValStrByKey(CHAttr.DeptNoT);
            }
            set
            {
                this.SetValByKey(CHAttr.DeptNoT, value);
            }
        }
        /// <summary>
        /// 年月
        ...
        public int NodeID
        {
            get
            {
                return this.GetValIntByKey(CHAttr.NodeID);
            }
            set
            {
                this.SetValByKey(CHAttr.NodeID, value);
            }
        }
        /// <summary>
        /// 节点名称
        ...
        public string NodeT
        {
            get
            {
                return this.GetValStrByKey(CHAttr.NodeIDT);
            }
            set
            {
                this.SetValByKey(CHAttr.NodeIDT, value);
            }
        }
        /// <summary>
        /// 总扣分
        ...
        public override Map EnMap
        {
            get
            {
                ...
                map.AddTBString(CHAttr.FlowNo, null, "流程", false, false, 0, 4, 3);
                map.AddTBString(CHAttr.FlowNoT, null, "流程名称", true, true, 0, 200, 5);

                map.AddTBInt(CHAttr.NodeID, 0, "节点", false, false);
                map.AddTBString(CHAttr.NodeIDT, null, "节点名称", true, true, 0, 200, 5);
                ...
                map.AddTBString(CHAttr.EmpNo, null, "当事人", true, true, 0, 100, 3);
                map.AddTBString(CHAttr.EmpNoT, null, "当事人名称", true, true, 0, 200, 5);
                ...
                map.AddTBString(CHAttr.DeptNo, null, "隶属部门", true, true, 0, 50, 5);
                map.AddTBString(CHAttr.DeptNoT, null, "部门名称", true, true, 0, 500, 5);
                map.AddTBString(CHAttr.FK_NY, null, "隶属月份", true, true, 0, 10, 10);

                map.AddTBInt(CHAttr.DTSWay, 1, "考核方式", false, false);
