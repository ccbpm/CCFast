...
namespace BP.WF.Data
{
    ...
    /// 自动报表-数据项
    /// </summary>
    public class AutoRptDtl : EntityOID
    {
        #region 属性
        public string Name
        {
            get
            {
                return this.GetValStringByKey(AutoRptDtlAttr.Name);
            }
            set
            {
                this.SetValByKey(AutoRptDtlAttr.Name, value);
            }
        }
        /// <summary>
        /// 对应的任务.
    ...
    /// 自动报表-数据项
    /// </summary>
    public class AutoRptDtls : EntitiesOID
    {
        #region 方法
        /// <summary>
        /// 得到它的 Entity 
