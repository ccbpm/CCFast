...
namespace BP.WF.Template
{
    ...
    public class FrmNode : EntityMyPK
    {
        ...
        public CCFrm HisFrm
        {
            get
            {
                ...
                {
                    this._hisFrm = new CCFrm(this.FrmID);
        ...
        public string FrmEnableRoleText
        {
            get
            {
                if (this.FrmEnableRole == FrmEnableRole.WhenHaveFrmPara && this.FrmID.Equals( "ND" + this.NodeID))
                    return "不启用";
        ...
        protected override bool beforeUpdateInsertAction()
        {
            ...
            this.setMyPK(this.FrmID + "_" + this.NodeID + "_" + this.FlowNo);

            //获取表单的类型
            MapData mapData = new MapData();
            mapData.No = this.FrmID;
    ...
    public class FrmNodes : EntitiesMyPK
    {
        ...
        public Nodes GetHisNodes(string NodeNo)
        {
            ...
            {
                ens.AddEntity(new Node(en.FrmID));
            }
            return ens;
        }
        /// <summary>
