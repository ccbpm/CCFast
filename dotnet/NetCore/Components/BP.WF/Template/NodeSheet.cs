    ...
    public class NodeSheet : Entity
    {
        ...
        public override Map EnMap
        {
            get
            {
                ...
                map.SetHelperUrl(NodeAttr.Step, "http://doc.ccbpm.cn/?v=5404&t=17902");
                //map.SetHelperAlert(NodeAttr.Step, "它用于节点的排序，正确的设置步骤可以让流程容易读写."); //使用alert的方式显示帮助信息.
                map.AddTBString(NodeAttr.FK_Flow, null, "流程编号", false, false, 0, 5, 10, false, "http://doc.ccbpm.cn/?v=5404&t=17023");
                map.AddTBString(NodeAttr.Name, null, "名称", true, true, 0, 100, 10, false, "http://doc.ccbpm.cn/?v=5404&t=17903");
                #endregion  基础属性
                ...
                map.AttrsOfOneVSM.AddGroupPanelModel(new BP.Port.TeamEmps(), new BP.Port.Teams(),
                   BP.Port.TeamEmpAttr.TeamNo,
                   BP.Port.TeamEmpAttr.EmpNo, "节点绑定人员", TeamAttr.FK_TeamType);
