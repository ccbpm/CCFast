...
namespace BP.WF.Template
{
    ...
    public class BtnAttr
    {
       ...
       // public const string IsCanAddHuiQianer = "IsCanAddHuiQianer";
        ...
        /// 下载公文是否启用
        /// </summary>
        public const string DownGovEnable = "DownGovEnable";

        /// <summary>
        /// KKFile公文预览是否启用
        /// </summary>
        public const string KKViewEnable = "KKViewEnable";
        /// <summary>
        /// 下载vsto插件是否启用
        /// </summary>
        public const string DownVSTOEnable = "DownVSTOEnable";
        /// <summary>
        /// 文件类型.
        /// </summary>
        ...
        /// 公文版本
        /// </summary>
        public const string OfficeTrackLab = "OfficeTrackLab";
        /// <summary>
        /// 下载公文标签
        /// </summary>
        public const string DownGovLab = "DownGovLab";
        /// <summary>
        /// KKFile公文预览
        /// </summary>
        public const string KKViewLab = "KKViewLab";
        /// <summary>
        /// 下载VSTO插件标签
        /// </summary>
        public const string DownVSTOLab = "DownVSTOLab";
        /// <summary>
        /// 公文版本是否启用
        /// </summary>
        public const string OfficeTrackEnalbe = "OfficeTrackEnalbe";
