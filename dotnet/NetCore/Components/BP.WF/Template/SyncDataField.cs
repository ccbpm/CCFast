    ...
    public class SyncDataField : EntityMyPK
    {
        ...
        public override Map EnMap
        {
            get
            {
                ...
                map.AddTBString("RefPKVal", null, "RefPK", false, false, 0, 50, 50, true);
                ...
                //string sql = "SELECT KeyOfEn as No, Name FROM Sys_MapAttr WHERE FK_MapData = '@FrmID' ORDER BY GroupID,Idx ";
                //map.SetPopList("ToFieldKey",, sql, false,"300px",,"500px",,"选字段",,"icon-people');
                ...
                map.AddTBString("TurnFunc", null, "转换函数", true, false, 0, 100, 50, false);
