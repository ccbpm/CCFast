...
namespace BP.WF.Template
{
    ...
    /// 也记录了到这个节点的其他的节点.
    /// </summary>
    public class NodeReturn : EntityMyPK
    {
        #region 基本属性
        /// <summary>
        /// UI界面上的访问控制
        ...
        public override Map EnMap
        {
            get
            {
                ...
                map.AddMyPK();
                map.AddTBInt(NodeReturnAttr.FK_Node, 0, "节点", true, true);
                map.AddTBInt(NodeReturnAttr.ReturnTo, 0, "退回到", true, true);
        ...
        {
            this.setMyPK(this.GetValIntByKey("FK_Node") + "_" + this.GetValIntByKey("ReturnTo"));
    ...
    /// 可退回的节点
    /// </summary>
    public class NodeReturns : EntitiesMyPK
    {
        /// <summary>
        /// 他的退回到
        /// </summary>
