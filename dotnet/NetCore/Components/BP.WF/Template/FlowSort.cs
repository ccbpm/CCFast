    ...
    public class FlowSort : EntityTree
    {
        ...
        public override Map EnMap
        {
            get
            {
                ...
                map.AddTBString("SortPath", null, "路径", true, false, 0, 200, 30, true);
        ...
        {
            //更新流程引擎控制表.
            string sql = "UPDATE WF_GenerWorkFlow SET DomainExt='" + this.DomainExt + "' WHERE FK_FlowSort='" + this.No + "'";
            DBAccess.RunSQL(sql);

            // sql = "UPDATE WF_Flow SET DomainExt='" + this.DomainExt + "' WHERE FK_FlowSort='" + this.No + "'";
            //DBAccess.RunSQL(sql);
        ...
        protected override bool beforeDelete()
        {
            ...
            {
                if (this.No == "100" || this.ParentNo == "100")
                {
                    throw new Exception("err@该目录是根目录或是独立组织的根目录，您不能删除。");
                }
            }
