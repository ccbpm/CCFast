    ...
    public class NodeExt : Entity
    {
        ...
        public override Map EnMap
        {
            get
            {
                ...
                // map.SetHelperUrl(NodeAttr.NodeID, "http://doc.ccbpm.cn/?v=5404&t=17901");
                ...
                //map.SetHelperUrl(NodeAttr.CondModel, "http://doc.ccbpm.cn/?v=5404&t=17917"); //增加帮助
                ...
                //map.AddBoolean(NodeAttr.IsTask, true, "允许分配工作否?", true, true, false, "http://doc.ccbpm.cn/?v=5404&t=17904");
                //map.AddBoolean(NodeAttr.IsExpSender, true, "本节点接收人不允许包含上一步发送人", true, true, false);
                //map.AddBoolean(NodeAttr.IsRM, true, "是否启用投递路径自动记忆功能?", true, true, false, "http://doc.ccbpm.cn/?v=5404&t=17905");
                ...
                map.AddTBString(NodeAttr.SelfFormEnRoot, null, "SelfFormEnRoot", true, false, 0, 200, 10, true);
