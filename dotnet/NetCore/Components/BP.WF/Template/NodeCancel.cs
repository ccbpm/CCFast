...
namespace BP.WF.Template
{
    ...
    /// 也记录了到这个节点的其他的节点.
    /// </summary>
    public class NodeCancel : EntityMyPK
    {
        #region 基本属性
        /// <summary>
        ///撤销到
        ...
        public override Map EnMap
        {
            get
            {
                ...
                map.AddTBInt(NodeCancelAttr.FK_Node, 0, "节点", true, true);
                map.AddTBInt(NodeCancelAttr.CancelTo, 0, "撤销到", true, true);
        ...
        {
            this.setMyPK(this.GetValIntByKey("FK_Node") + "_" + this.GetValIntByKey("CancelTo"));
    ...
    /// 可撤销的节点
    /// </summary>
    public class NodeCancels : EntitiesMyPK
    {
        #region 构造与属性.
        /// <summary>
        /// 他的撤销到
