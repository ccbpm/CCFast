        ...
        public override Map EnMap
        {
            get
            {
                ...
                map.AddDDLSysEnum(NodeWorkCheckAttr.FWCShowModel, (int)FrmWorkShowModel.Free, "显示方式",
                    true, true, NodeWorkCheckAttr.FWCShowModel, "@0=表格方式@1=自由模式@2=轨迹时间轴模式"); //此属性暂时没有用.
                ...
                //增加.
                map.AddTBInt("FWCShowModel", 0, "工作模式", false, false);
                map.AddTBInt("FWCTimeModel", 0, "时序模式", false, false);
