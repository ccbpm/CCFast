...
namespace BP.WF.Template
{
    ...
    public class BtnLab : Entity
    {
        ...
        /// 下载公文公文是否启用
        /// </summary>
        public bool DownGovEnable
        {
            get
            {
                return this.GetValBooleanByKey(BtnAttr.DownGovEnable);
            }
        }
        ...
        /// KKFile公文正文预览
        /// </summary>
        public bool KKViewEnable
        {
            get
            {
                return this.GetValBooleanByKey(BtnAttr.KKViewEnable);
            }
        ...
        /// VSTO下载插件是否启用
        /// </summary>
        public bool DownVSTOEnable
        {
            get
            {
                return this.GetValBooleanByKey(BtnAttr.DownVSTOEnable);
            }
        ...
        /// 公文版本是否开启
        /// </summary>
        public bool OfficeTrackEnalbe
        {
            get
            {
                return this.GetValBooleanByKey(BtnAttr.OfficeTrackEnalbe);
            }
        }
        ...
        /// 公文版本标签
        /// </summary>
        public string OfficeTrackLab
        {
            get
            {
                return this.GetValStrByKey(BtnAttr.OfficeTrackLab);
            }
        }
        ...
        /// 下载公文版本标签
        /// </summary>
        public string DownGovLab
        {
            get
            {
                return this.GetValStrByKey(BtnAttr.DownGovLab);
            }
        }
        ...
        /// KKFile公文预览标签
        /// </summary>
        public string KKViewLab
        {
            get
            {
                return this.GetValStrByKey(BtnAttr.KKViewLab);
            }
        }
        ...
        /// 下载VSTO插件标签
        /// </summary>
        public string DownVSTOLab
        {
            get
            {
                return this.GetValStrByKey(BtnAttr.DownVSTOLab);
            }
        }
        ...
        /// 公文文件类型
        /// </summary>
        public bool OfficeFileType
        {
            get
            {
                return this.GetValBooleanByKey(BtnAttr.OfficeFileType);
            }
        }
        ...
        public override Map EnMap
        {
            get
            {
                ...
                //  map.SetHelperUrl(NodeAttr.CCWriteTo, "http://doc.ccbpm.cn/?v=5404&t=17976"); //增加帮助.
         ...
         "@0=工具栏上@1=表单标签(divID=GovDocFile)", false);
                ...
                //map.SetHelperUrl(BtnAttr.TrackLab, "http://doc.ccbpm.cn/?v=5404&t=24369");
                ...
                //      map.SetHelperUrl(BtnAttr.SelectAccepterLab, "http://doc.ccbpm.cn/?v=5404&t=16256"); //增加帮助
                ...
                //map.SetHelperUrl(BtnAttr.BatchLab, "http://doc.ccbpm.cn/?v=5404&t=17920"); //增加帮助

                //功能暂时取消
                //map.AddTBString(BtnAttr.AskforLab, "加签", "加签按钮标签", true, false, 0, 50, 10);
                //map.AddBoolean(BtnAttr.AskforEnable, false, "是否启用", true, true);
                //map.SetHelperUrl(BtnAttr.AskforLab, "http://doc.ccbpm.cn/?v=5404&t=16258");
                ...
                //map.SetHelperUrl(BtnAttr.WebOfficeLab, "http://doc.ccbpm.cn/?v=5404&t=17993");
           ...
           NodeAttr.ThreadKillRole, "@0=不能删除@1=手工删除@2=自动删除", true);
                ...
                map.AddBoolean(BtnAttr.PrintDocEnable, false, "是否启用", true, true);
                //map.SetHelperUrl(BtnAttr.PrintDocEnable, "http://doc.ccbpm.cn/?v=5404&t=17979"); //增加帮助
                //map.SetHelperUrl(BtnAttr.BatchLab, "https://gitee.com/opencc/JFlow/wikis/pages/preview?sort_id=3979986&doc_id=31094");
                #endregion
