...
namespace BP.WF.Admin
{
    ...
    public class Org : EntityNoName
    {
        ...
        protected override bool beforeUpdateInsertAction()
        {
            ...
            this.SetValByKey("FlowNums", DBAccess.RunSQLReturnValIntPara("SELECT COUNT(*) AS a FROM WF_Flow WHERE OrgNo=" + SystemConfig.AppCenterDBVarStr + "V", WebUser.OrgNo));
            this.SetValByKey("FrmNums", DBAccess.RunSQLReturnValIntPara("SELECT COUNT(*) AS a FROM Sys_MapData WHERE   OrgNo=" + SystemConfig.AppCenterDBVarStr + "V", WebUser.OrgNo));

            this.SetValByKey("Users", DBAccess.RunSQLReturnValIntPara("SELECT COUNT(*) AS a FROM Port_Emp WHERE  OrgNo=" + SystemConfig.AppCenterDBVarStr + "V", WebUser.OrgNo));
            this.SetValByKey("Depts", DBAccess.RunSQLReturnValIntPara("SELECT COUNT(*) AS a FROM Port_Dept WHERE  OrgNo=" + SystemConfig.AppCenterDBVarStr + "V", WebUser.OrgNo));
