...
namespace BP.Port.DINGTalk
{
    ...
    /// 钉钉角色返回信息
    /// </summary>
    public class Ding_Role_request
    { 
        public string request_id { get; set; }
        public string errcode { get; set; }
        public string errmsg { get; set; }
        public Ding_Role_PageVo result { get; set; }
    }
    /// <summary>
    /// 角色返回具体信息
    /// </summary>
    public class Ding_Role_PageVo
    { 
        public bool hasMore { get; set; }
        public List<Ding_Role_Group_List> list { get; set; }
    }
    /// <summary>
    /// 角色分组
    /// </summary>
    public class Ding_Role_Group_List
    { 
        public string groupId { get; set; }
        public string name { get; set; }
        public List<Ding_Role_List> roles { get; set; }
    }
    /// <summary>
    /// 角色列表
    /// </summary>
    public class Ding_Role_List
    { 
        public string id { get; set; }
        public string name { get; set; }
    }
    ...
    /// 获取指定角色的员工列表的消息体
    /// </summary>
    public class Ding_Role_User_Request
    {
        public string request_id { get; set; }
        public string errcode { get; set; }
        public string errmsg { get; set; }
        public Ding_Role_User_PageVo result { get; set; }
    }
    //获取指定角色的员工列表的返回值
    public class Ding_Role_User_PageVo
    {
        public bool hasMore { get; set; }
        public List<Ding_Role_User_List> list { get; set; }
    }
    /// <summary>
    /// 获取指定角色的员工列表
    /// </summary>
    public class Ding_Role_User_List
    { 
        public string name { get; set; }
        public string userid { get; set; }
        public List<Ding_Role_User_Scopes> manageScopes { get; set; }
    }
    /// <summary>
    /// 获取指定角色的员工所属的部门集合
    /// </summary>
    public class Ding_Role_User_Scopes
    { 
