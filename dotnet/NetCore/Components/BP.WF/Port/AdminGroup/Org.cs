...
namespace BP.WF.Port.AdminGroup
{
    ...
    public class Org : EntityNoName
    {
        ...
        public string DeleteOrg()
        {
            ...
            //更新到admin的组织下.
            string sqls = "UPDATE Port_Emp SET OrgNo='" + BP.Web.WebUser.OrgNo + "' WHERE OrgNo='" + this.No + "'";
            sqls += "@UPDATE Port_Dept SET OrgNo='" + BP.Web.WebUser.OrgNo + "' WHERE OrgNo='" + this.No + "'";
            sqls += "@UPDATE Port_DeptEmp SET OrgNo='" + BP.Web.WebUser.OrgNo + "' WHERE OrgNo='" + this.No + "'";
            sqls += "@UPDATE Port_DeptEmpStation SET OrgNo='" + BP.Web.WebUser.OrgNo + "' WHERE OrgNo='" + this.No + "'";
