    ...
    public class FrmBill : EntityNoName
    {
        ...
        public override Map EnMap
        {
            get
            {
                ...
                map.AddDDLSysEnum(MapDataAttr.TableCol, 0, "表单显示列数", true, true, "经典表单显示方式",
                 "@0=4列@1=6列@2=上下模式3列");
                ...
                //处理审核信息.
                map.AddTBString("BillCheckModel", null, "审核模式", false, false, 0, 20, 10, true, null);
                map.AddTBString("BillCheckTag", null, "审核流程", false, false, 0, 300, 10, true, null);
                #endregion 按钮权限.
        ...
        {
            //删除数据防止错误.
            DBAccess.RunSQL("DELETE FROM Frm_ToolbarBtn WHERE FrmID='" + this.No + "'");
            //表单的工具栏权限
            ...
            btn.Insert();
            //删除已经存在的.
            DBAccess.RunSQL("DELETE FROM Frm_Collection WHERE FrmID='" + this.No + "'");
            //列表权限
            //查询
