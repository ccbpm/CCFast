        ...
        public override Map EnMap
        {
            get
            {
              ...
              //  map.AddTBInt(TrackAttr.WorkID, 0, "工作ID/OID", true, false);
                ...
                map.AddTBString(TrackAttr.RecNo, null, "记录人", true, false, 0, 200, 100);
                map.AddTBString(TrackAttr.RecName, null, "名称", true, false, 0, 200, 100);
                map.AddTBDateTime(TrackAttr.RDT, null, "记录日期时间", true, false);

                map.AddTBString(TrackAttr.DeptNo, null, "部门编号", true, false, 0, 100, 100);
                map.AddTBString(TrackAttr.DeptName, null, "部门名称", true, false, 0, 150, 100);
                #endregion 基本字段
