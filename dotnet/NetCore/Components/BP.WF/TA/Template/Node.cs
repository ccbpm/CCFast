...
namespace BP.TA
{
    ...
    public class Node : EntityTree
    {
        ...
        {
            ////更新流程引擎控制表.
            //string sql = "UPDATE WF_GenerWorkFlow SET DomainExt="" + this.DomainExt + "" WHERE FK_Node="" + this.No + """;
            //DBAccess.RunSQL(sql);

            //// sql = "UPDATE WF_Flow SET DomainExt="" + this.DomainExt + "" WHERE FK_Node="" + this.No + """;
            ////DBAccess.RunSQL(sql);
