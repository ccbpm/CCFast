    ...
    public class CCBill_FlowEvent
    {
        ...
        public static void DealFlowOver(WorkNode wn, string paras)
        {
            ...
            if (wn.HisGenerWorkFlow.GetParaBoolen("FlowBaseData", false) == true)
            {
                ...
                //修改实体信息.
                BP.CCBill.Dev2Interface.WriteTrack(dictFrmID, wn.WorkID.ToString(), CCBill.FrmActionType.FlowBaseData, "流程修改实体数据",
            ...
            if (wn.HisGenerWorkFlow.GetParaBoolen("FlowNewEntity", false) == true)
            {
                ...
                BP.CCBill.Dev2Interface.WriteTrack(menu.FrmID,  wn.WorkID.ToString(), CCBill.FrmActionType.StartRegFlow, "流程创建实体",
