...
namespace BP.WF
{
    ...
    public class WorkFlowBuessRole
    {
        ...
        /// 按照参数字段替换标题
        /// 如：@AtPara.xxTitle会获取GenerWorkFlow的AtPara字段@xxTitle的标题
        ...
        private static string processAtPara(string titleRole, long workID)
        {
            // 求出GenerWorkFlow
            ...
            if (i > 0)
            {
                ...
                {
                    AtPara atPara = new AtPara();
                    // 判断键是否存在
                    if (!atPara.HisHT.ContainsKey(key))
                    {
        ...
        public static string GenerTitle(Flow fl, Work wk, Emp emp, string rdt)
        {
            ...
            {
                titleRole = processAtPara(titleRole, wk.OID);
            }
            ...
            titleRole = titleRole.Replace("@WebUser.DeptNo", emp.DeptNo);
