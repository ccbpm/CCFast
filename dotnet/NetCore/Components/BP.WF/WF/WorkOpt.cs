    ...
    public class WorkOpt : EntityMyPK
    {
        ...
        public override Map EnMap
        {
            get
            {
                ...
                map.AddBoolean("IsJiaoJi", false, "是否求角色与部门的交集?", true, true, true);

                map.AddTBString("SendDeptLeaders", null, "到部门领导", true, true, 0, 500, 10, true);
                map.AddTBString("SendDeptLeadersT", null, "到部门领导T", false, false, 0, 500, 10, true);
