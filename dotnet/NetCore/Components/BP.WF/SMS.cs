...
namespace BP.WF
{
    ...
    public class SMS : EntityMyPK
    {
        ...
        public static bool SendEmailNowAsync(string mail, string mailTitle, string mailDoc)
        {
            ...
            //TSEntityNoName en = new TSEntityNoName("TS.Demo.Student");
            //en.No = mail;
            //en.Retrieve();
            //en.Insert();
            //en.Update();
            ...
            {
                BP.DA.Log.DebugWriteError(BP.Difference.SystemConfig.GetValByKey("SendEmailAddress", null));
                BP.DA.Log.DebugWriteError(BP.Difference.SystemConfig.GetValByKey("SendEmailHost", "smtp.gmail.com"));
