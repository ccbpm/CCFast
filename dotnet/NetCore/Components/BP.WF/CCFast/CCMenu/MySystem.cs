...
namespace BP.CCFast.CCMenu
{
    ...
    public class MySystemAttr : EntityNoNameAttr
    {
        ...
        //待办
        public const string Todolist_EmpWorks = "Todolist_EmpWorks";
        //草稿
        public const string Todolist_Draft = "Todolist_Draft";
        //已完成
        public const string Todolist_Complete = "Todolist_Complete";
        //退回
        public const string Todolist_ReturnNum = "Todolist_ReturnNum";
        //抄送
        public const string Todolist_CCWorks = "Todolist_CCWorks";
        //逾期
        public const string Todolist_OverWorkNum = "Todolist_OverWorkNum";
        //未阅
        public const string Todolist_UnRead = "Todolist_UnRead";
        //挂起
        public const string Todolist_HungupNum = "Todolist_HungupNum";
    }
    /// <summary>
    /// 系统
    /// </summary>
    public class MySystem : EntityNoName
    {
        ...
        public int Todolist_OverWorkNum
        {
            get
            {
        ...
        public override Map EnMap
        {
            get
            {
                ...
                map.AddTBString("CreateNo", null, "创建人编码", false, true, 0, 50, 30, true);
                map.AddTBString("CreateName", null, "创建人", false, true, 0, 200, 30, true);
