    ...
    public class AutoRunStratFlows : Method
    {
        ...
        public override object Do()
        {
            ...
            foreach (BP.WF.Flow fl in fls)
            {
                ...
                if (fl.HisFlowRunWay == FlowRunWay.SpecEmpAdv || fl.HisFlowRunWay == FlowRunWay.SpecEmp || fl.HisFlowRunWay == FlowRunWay.LetAdminSendSpecEmp)
                {
                    ...
                    if (fl.HisFlowRunWay == FlowRunWay.SpecEmpAdv || fl.HisFlowRunWay == FlowRunWay.LetAdminSendSpecEmp)
        ...
        public string LetAdminSendSpecEmp(Flow fl)
        {
            ...
            try
            {
                ...
                BP.WF.Dev2Interface.Node_SendWork(fl.No, workID, 0, emps.Join(","));
            ...
            {
                Console.WriteLine("流程:" + fl.No + fl.Name + "自动发起错误:\t\n -------------- \t\n" + ex.Message);
                BP.DA.Log.DebugWriteError("流程:" + fl.No + fl.Name + "自动发起错误:\t\n -------------- \t\n" + ex.Message);
            }
            return msg;
        }
