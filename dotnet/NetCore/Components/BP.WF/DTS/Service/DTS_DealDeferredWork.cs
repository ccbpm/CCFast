            ...
            foreach (DataRow dr in dt.Rows)
            {
                ...
                switch (nd.HisOutTimeDeal)
                {
                    ...
                    case OutTimeDeal.AutoTurntoNextStep: //自动转到下一步骤.
                        ...
                        {
                            /*检查审核意见 */
                            String sql1 = "SELECT Msg \"Msg\",EmpToT \"EmpToT\" FROM ND" + Int32.Parse(nd.FlowNo) + "Track WHERE  EmpFrom='" + WebUser.No + "' AND NDFrom=" + nd.NodeID + " AND WorkID=" + workid + " AND ActionType=" + (int)ActionType.WorkCheck;
