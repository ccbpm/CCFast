var W=Object.defineProperty;var p=(l,s,t)=>s in l?W(l,s,{enumerable:!0,configurable:!0,writable:!0,value:t}):l[s]=t;var a=(l,s,t)=>p(l,typeof s!="symbol"?s+"":s,t);var d=(l,s,t)=>new Promise((e,n)=>{var u=r=>{try{i(t.next(r))}catch(o){n(o)}},c=r=>{try{i(t.throw(r))}catch(o){n(o)}},i=r=>r.done?e(r.value):Promise.resolve(r.value).then(u,c);i((t=t.apply(l,s)).next())});import{b9 as N,aB as w,aC as h}from"./entry/index-M8VErHPE-1727507756861.js";import A from"./HttpHandler-Ebi1068_.js";import"./vue-DGeTOT5N.js";import"./antd-DkiF_jXA.js";class _ extends N{constructor(){super("GPN_AIFlowNew");a(this,"AlertCar",`
    我要做一个车辆申请流程，如
