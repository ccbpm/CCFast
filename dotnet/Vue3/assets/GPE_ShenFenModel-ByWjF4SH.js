var d=Object.defineProperty;var g=(s,t,e)=>t in s?d(s,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):s[t]=e;var i=(s,t,e)=>g(s,typeof t!="symbol"?t+"":t,e);var m=(s,t,e)=>new Promise((r,c)=>{var n=o=>{try{a(e.next(o))}catch(h){c(h)}},F=o=>{try{a(e.throw(o))}catch(h){c(h)}},a=o=>o.done?r(o.value):Promise.resolve(o.value).then(n,F);a((e=e.apply(s,t)).next())});import{aM as S}from"./entry/index-M8VErHPE-1727507756861.js";import{PageBaseGroupEdit as A}from"./PageBaseGroupEdit-JIgqoTiq.js";import{Node as p,NodeAttr as l}from"./Node-B6HRFhwD.js";import"./vue-DGeTOT5N.js";import"./antd-DkiF_jXA.js";import"./Help-D0bDMZWg.js";import"./EntityNodeID-De9k9loD.js";class _ extends A{constructor(){super("GPE_ShenFenModel");i(this,"Desc3",`
  #### 说明
   - 表单采集的是一个部门编号.
   - 使用这个部门编号作为当前人员的身份.
    `);i(this,"Desc5",`
