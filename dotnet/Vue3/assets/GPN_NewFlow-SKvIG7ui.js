var N=Object.defineProperty;var T=(a,F,e)=>F in a?N(a,F,{enumerable:!0,configurable:!0,writable:!0,value:e}):a[F]=e;var n=(a,F,e)=>T(a,typeof F!="symbol"?F+"":F,e);var d=(a,F,e)=>new Promise((l,s)=>{var w=r=>{try{t(e.next(r))}catch(o){s(o)}},m=r=>{try{t(e.throw(r))}catch(o){s(o)}},t=r=>r.done?l(r.value):Promise.resolve(r.value).then(w,m);t((e=e.apply(a,F)).next())});import{b5 as W,aM as S,G as x,l as u,H as A}from"./entry/index-C6uBgOW5-1730430676707.js";import{FlowSorts as y}from"./FlowSort-Ddcih9CP.js";import{FlowDevModel as c}from"./EnumLab-CzismWql.js";import{useClassFactoryLoader as D}from"./useClassFactoryLoader-BD5OXTRg.js";import{GloComm as h}from"./GloComm-CmAl8MpM.js";import{b as p}from"./antd-Dd9L3uAF.js";import"./vue-BXIlYw1E.js";import"./DBAccess-sLO0RM-h.js";import"./SFTable-BlM1UBse.js";import"./SFDBSrc-DKIMsnoa.js";import"./SFPara-T412M7pO.js";import"./SFColumn-CXmWKoZg.js";import"./MapAttr-B1mxD3vP.js";import"./Events-D9tOL1Ad.js";import"./FlowAdm-CMaXNd58.js";import"./Sort-CGZ6d0xm.js";import"./FrmTrack-BAfWiAdt.js";class q extends W{constructor(){super("GPN_NewFlow");n(this,"TaskTree",` 
  #### 帮助
...
`);n(this,"RefFrm",`
  ...
  `);this.PageTitle="新建流程"}Init(){return d(this,null,function*(){this.AddGroup("A","内置表单模式"),this.TextBox1_Name("JiJian","极简模式",this.JiJian,"流程名称","我的极简流程"),this.TextBox1_Name("Profession","专业模式",this.Profession,"流程名称","我的专业流程"),this.AddGroup("B","绑定表单模式"),this.TextBox1_Name("RefOneFrmTree","绑定单表单",this.RefFrm,"流程名称","我的单表单流程"),this.SelectItemsByGroupList("RefOneFrmTree.SelectOneFrm","选择表单",this.RefFrm_SelectOneFrm,!1,S.srcFrmTree,S.srcBindFrmList),this.TextBox1_Name("FrmTree","绑定多表单",this.FrmTree_SelectFrms,"流程名称","我的多表单流程"),this.SelectItemsByGroupList("FrmTree.SelectFrms","选择表单",this.FrmTree_SelectFrms,!0,S.srcFrmTree,S.srcBindFrmList),this.AddGroup("D","使用高代码"),this.TextBox1_Name("EntityTS","绑定高代码",this.EntityTS,"流程名称","我的高代码流程"),this.SelectItemsByList("EntityTS.SelectOneEntityTS","选择Entity实体",this.EntityTS_SelectOneEntity,!1,yield this.GenerEnsList()),this.AddGroup("C","使用AI创建"),this.AddHelp("AI","使用AI创建","使用AI创建,调用AI大模型创建流程.");const e=h.UrlGPN("GPN_AIFlowNew","","&SortNo=123");this.AddGoToUrl("AI.AIFlow","使用AI创建",e)})}GenerEnsList(){return d(this,null,function*(){return yield(yield D("ClassFactory")).toJSON([])})}GenerSorts(){return d(this,null,function*(){const e=new y;return yield e.RetrieveAll(),e})}Save_TextBox_X(e,l,s,w,m){return d(this,null,function*(){if(e=="AI.AIFlow"){const t=h.UrlGPN("GPN_AIFlowNew","","&SortNo="+l);return new x(u.OpenUrlByNewWindow,t)}if(e==="Profession"||e==="JiJian"){const t=s,r=w;let o=c.Prefessional;e=="JiJian"&&(o=c.JiJian);const i=yield this.creteFlow(l,o,t,r,m);if(i==null)return;const f="/#/WF/Designer/EditFlow?FlowNo="+i;return new x(u.OpenUrlByNewWindow,f)}if(e=="SDKFrmWorkID"||e=="SDKFrmWorkID"||e=="QianRuFrm"){const t=w,r=s,o=yield this.creteFlow(l,c.SDKFrm,t,r,m);if(o==null)return;const i="/#/WF/Designer/EditFlow?FlowNo="+o;return new x(u.OpenUrlByNewWindow,i)}if(e==="RefOneFrmTree.SelectOneFrm"){const t=this.RequestVal("tb1","RefOneFrmTree"),r=s,o=yield this.creteFlow(l,c.RefOneFrmTree,t,r,m);if(o==null)return;const i="/#/WF/Designer/EditFlow?FlowNo="+o;return new x(u.OpenUrlByNewWindow,i)}if(e==="FrmTree.SelectFrms"){const t=this.RequestVal("tb1","FrmTree"),r=s,o=yield this.creteFlow(l,c.FrmTree,t,r,m);if(o==null)return;const i="/#/WF/Designer/EditFlow?FlowNo="+o;return new x(u.OpenUrlByNewWindow,i)}if(e==="FrmExcel"||e==="FrmWord"){const t=s,r=w;let o=c.FrmWord;e=="FrmExcel"&&(o=c.FrmExcel),e=="FrmWord"&&(o=c.FrmWord);const i=yield this.creteFlow(l,o,t,r,m);if(i==null)return;const f="/#/WF/Designer/EditFlow?FlowNo="+i;return new x(u.OpenUrlByNewWindow,f)}if(e==="TaskTreeSimple"){const t=s,r=w,o=c.TaskTree,i=yield this.creteFlow(l,o,t,r,m);if(i==null)return;p.info("流程创建成功,模板编号:"+i);const f="/#/WF/Designer/EditFlow?FlowNo="+i;return new x(u.OpenUrlByNewWindow,f)}if(e==="EntityTS.SelectOneEntityTS"){const t=this.RequestVal("tb1","EntityTS"),r=s,o=yield this.creteFlow(l,c.EntityTS,t,r,m);if(o==null)return;const i="/#/WF/Designer/EditFlow?FlowNo="+o;return new x(u.OpenUrlByNewWindow,i)}})}creteFlow(e,l,s,w,m){return d(this,null,function*(){const t=new A("BP.WF.HttpHandler.WF_Admin_CCBPMDesigner_FlowDevModel");t.AddPara("SortNo",e),t.AddPara("FlowName",s),t.AddPara("FlowDevModel",l),t.AddPara("FrmUrl",w),t.AddPara("FrmPK",m);const r=yield t.DoMethodReturnString("FlowDevModel_Save");return r==null||r==null?(p.info("创建失败:"+r),null):(p.info("流程创建成功,模板编号:"+r),r)})}}export{q as GPN_NewFlow};
