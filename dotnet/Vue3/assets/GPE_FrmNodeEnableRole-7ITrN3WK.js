var n=Object.defineProperty;var F=(s,t,e)=>t in s?n(s,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):s[t]=e;var r=(s,t,e)=>F(s,typeof t!="symbol"?t+"":t,e);import{bi as i,aM as c}from"./entry/index-C6uBgOW5-1730430676707.js";import{FrmNode as p,FrmNodeAttr as m}from"./FrmNode-C2BSQEvr.js";import{PageBaseGroupEdit as h}from"./PageBaseGroupEdit-IicyYiex.js";import"./vue-BXIlYw1E.js";import"./antd-Dd9L3uAF.js";import"./Help-D0bDMZWg.js";class y extends h{constructor(){super("GPE_FrmNodeEnableRole");r(this,"Desc0",`
  #### 帮助
   - 始终启用该表单, 默认为始终启用.
   #### 定义
  ...
  `);this.PageTitle="启用规则"}Init(){this.entity=new p,this.KeyOfEn=m.FrmEnableRole,this.AddGroup("A","表单启用规则"),this.Blank("0","始终启用(默认)",this.Desc0),this.Blank("1","有数据时启用",this.Desc1),this.Blank("2","有参数时启用",this.Desc2),this.SingleTBSQL("4","按SQL表达式计算",m.FrmEnableExp,this.Desc4,"输入查询SQL,支持ccbpm表达式"),this.AddGroup("B","按操作员的身份"),this.SelectItemsByGroupList("6","包含角色启用",this.Desc6,!0,i.srcGroupStationTypes,i.srcListStations,m.FrmEnableExp),this.SelectItemsByTree("7","包含部门启用",this.Desc7,!0,i.srcTreeDept,"0",m.FrmEnableExp),this.SelectItemsByTreeEns("8","包含人员启动",this.Desc7,!0,c.srcDeptLazily,c.srcDeptRoot,c.srcEmpLazily,"@No=账号@Name=名称@Tel=电话",m.FrmEnableExp),this.Blank("10","禁用","不启用该表单.")}AfterSave(e,o){if(e==o)throw new Error("Method not implemented.")}BtnClick(e,o,l){if(e==o||e===l)throw new Error("Method not implemented.")}}export{y as GPE_FrmNodeEnableRole};
