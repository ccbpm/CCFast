...
`)),new m(A.Message,e)}if(i=="DingDingDtl"){const t=this.UploadFilArr,e=this.FolderName,a=new h("BP.WF.HttpHandler.WF_Admin_AttrFlow");for(const g of t)a.AddFile(g==null?void 0:g.originFileObj);a.AddPara("FlowNo",r),a.AddPara("AthName",e||"");let l=yield a.DoMethodReturnString("DingDing_ImpAths");return typeof l=="string"&&l.includes("@")&&(l=l.split("@").join(`
`)),new m(A.Message,l)}})}}export{W as GPN_ImpFlowData};
