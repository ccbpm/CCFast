var N=Object.defineProperty;var P=(o,s,t)=>s in o?N(o,s,{enumerable:!0,configurable:!0,writable:!0,value:t}):o[s]=t;var i=(o,s,t)=>P(o,typeof s!="symbol"?s+"":s,t);var I=(o,s,t)=>new Promise((C,c)=>{var a=r=>{try{e(t.next(r))}catch(m){c(m)}},l=r=>{try{e(t.throw(r))}catch(m){c(m)}},e=r=>r.done?C(r.value):Promise.resolve(r.value).then(a,l);e((t=t.apply(o,s)).next())});import{b9 as g,aM as n,aB as F,aC as u}from"./entry/index-M8VErHPE-1727507756861.js";import{MapData as p}from"./MapData-lfC2UY9r.js";import{e as d}from"./antd-DkiF_jXA.js";import"./vue-DGeTOT5N.js";import"./EnumLab-CzismWql.js";class B extends g{constructor(){super("GPN_DBList");i(this,"Docs0",`
  #### 帮助
  - 所有人都可以有权限。
  #### 配置图
...
`);i(this,"Docs1",`
  ...
  `);this.PageTitle="数据源实体"}Init(){this.AddGroup("A","数据源实体"),this.TextBox3_NameNoNote("FrmID","按表单ID创建",this.HelpTodo,"DB_","请输入数据源ID","输入数据源名称","请输入表单ID","我的数据源"),this.SelectItemsByGroupList("FrmID.Table","主表字段",this.HelpTodo,!0,n.srcFrmGroups,n.srcFrmFields),this.SelectItemsByGroupList("FrmID.Table.SelectDtl","选择从表",this.HelpTodo,!0,n.srcFrmGroups,n.srcFrmFields),this.SelectItemsByGroupList("FrmID.Table.SelectDtl.Dtl","从表字段",this.HelpTodo,!0,n.srcFrmGroups,n.srcFrmFields),this.TextBox2_NameNo("View","按关系数据源创建",this.HelpTodo,"DBList","输入ID","输入名称","输入表单ID"),this.TextSQL("View.SQL","输入查询SQL",this.HelpTodo,"DBList","SELECT No as OID, No as BillNo,  Name as Title, Tel,Email  FROM Port_Emp","请输入SQL")}GenerSorts(){return I(this,null,function*(){return Promise.resolve([])})}Save_TextBox_X(t,C,c,a,l){return I(this,null,function*(){if(t=="View"){const e=new p;if(e.No=a,(yield e.IsExits())==!1)return d.info("ID:"+a+"已经存在,请重命名."),new F(u.CloseAndReload)}if(t=="FrmID"){const e=new p;if(e.No=a,(yield e.IsExits())==!1)return d.info("ID:"+a+"已经存在,请重命名."),new F(u.CloseAndReload);if(e.No=l,(yield e.IsExits())==!1)return d.info("输入表单ID"+l+"不存在."),new F(u.CloseAndReload)}if(t=="FrmID.TableField.Dtl"){const e=this.RequestVal("tb1","FrmID"),r=this.RequestVal("tb2","FrmID"),m=this.RequestVal("tb3","FrmID");this.RequestVal("tb1","FrmID.TableField"),this.RequestVal("tb1","FrmID.TableField.Dtl");const T=new p;T.No=m,yield T.RetrieveFromDBSources();const D=new p;D.No=e,D.Name=r,D.PTable=e,yield D.Insert()}})}}export{B as GPN_DBList};
