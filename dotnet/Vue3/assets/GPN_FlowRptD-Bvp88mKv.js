var p=Object.defineProperty;var m=(n,r,t)=>r in n?p(n,r,{enumerable:!0,configurable:!0,writable:!0,value:t}):n[r]=t;var e=(n,r,t)=>m(n,typeof r!="symbol"?r+"":r,t);var i=(n,r,t)=>new Promise((u,s)=>{var l=o=>{try{a(t.next(o))}catch(d){s(d)}},c=o=>{try{a(t.throw(o))}catch(d){s(d)}},a=o=>o.done?u(o.value):Promise.resolve(o.value).then(l,c);a((t=t.apply(n,r)).next())});import{b9 as g}from"./entry/index-M8VErHPE-1727507756861.js";import"./vue-DGeTOT5N.js";import"./antd-DkiF_jXA.js";class I extends g{constructor(){super("GPN_FlowRptD");e(this,"HelpFlow",`
  #### 帮助
  - 如何把流程绑定到您的业务系统中？
  - 如何在一行记录上启动流程、传入数据？
