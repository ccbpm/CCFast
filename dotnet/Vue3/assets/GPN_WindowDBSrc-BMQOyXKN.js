var u=Object.defineProperty;var F=(r,t,e)=>t in r?u(r,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):r[t]=e;var s=(r,t,e)=>F(r,typeof t!="symbol"?t+"":t,e);var i=(r,t,e)=>new Promise((n,N)=>{var l=o=>{try{a(e.next(o))}catch(p){N(p)}},c=o=>{try{a(e.throw(o))}catch(p){N(p)}},a=o=>o.done?n(o.value):Promise.resolve(o.value).then(l,c);a((e=e.apply(r,t)).next())});import{WinDocModel as m}from"./WinDocModel-BUMXT_mN.js";import{WindowTemplate as y}from"./WindowTemplate-BSgIc8PU.js";import{b9 as D,aB as E,aC as S}from"./entry/index-M8VErHPE-1727507756861.js";import{GloComm as f}from"./GloComm-DZ1gELjv.js";import"./vue-DGeTOT5N.js";import"./antd-DkiF_jXA.js";import"./FrmTrack-0uAZQ3B_.js";import"./DBAccess-CzjFzLoq.js";import"./SFPara-DL_8hzxu.js";import"./SFColumn-Q_PoS_2g.js";class W extends D{constructor(){super("GPN_WindowDBSrc");s(this,"WebApi",`
  #### 帮助
  - 执行定义的过程.
