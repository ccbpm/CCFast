var n=Object.defineProperty;var l=(i,r,e)=>r in i?n(i,r,{enumerable:!0,configurable:!0,writable:!0,value:e}):i[r]=e;var t=(i,r,e)=>l(i,typeof r!="symbol"?r+"":r,e);import{aM as s,aD as a}from"./entry/index-M8VErHPE-1727507756861.js";import{PageBaseGroupEdit as F}from"./PageBaseGroupEdit-JIgqoTiq.js";import{Flow as p,FlowAttr as o}from"./Flow-D1QXg1UO.js";import"./vue-DGeTOT5N.js";import"./antd-DkiF_jXA.js";import"./Help-D0bDMZWg.js";class g extends F{constructor(){super("GPE_FlowDevModel");t(this,"Profession",`
  #### 帮助
  ...
  ![输入图片说明](/resource/WF/Admin/AttrFlow/Limit/Img/LimitSetting.png "屏幕截图.png")
   ...
   - 如果使用绝对路径可以使用ccbpm的全局变量@SDKFromServHost ，比如: @SDKFromServHost/MyFile.htm
     ...
     `);this.PageTitle="设计模式"}Init(){this.entity=new p,this.KeyOfEn=o.DevModelType,this.AddGroup("A","内置表单模式"),this.Blank("Profession","专业模式",this.Profession),this.Blank("JiJian","极简模式",this.JiJian),this.AddGroup("B","绑定表单库模式"),this.SelectItemsByGroupList("RefFrm","绑表单库的表单",this.RefFrm,!1,s.srcFrmTree,s.srcFrmList,o.DevModelPara),this.SelectItemsByGroupList("FrmTree","表单树",this.FrmTree,!0,s.srcFrmTree,s.srcFrmList,o.DevModelPara),this.AddGroup("C","自定义表单模式"),this.SingleTB("SDKFrm","SDK表单",o.DevModelPara,this.SDKFrm,"请输入表单URL",a.AppString),this.SingleTB("QianRuFrm","嵌入式表单",o.DevModelPara,this.QianRuFrm,"请输入表单URL",a.AppString)}AfterSave(e,m){if(e==m)throw new Error("Method not implemented.")}BtnClick(e,m,h){}}export{g as GPE_FlowDevModel};
