var h=Object.defineProperty;var W=(a,m,e)=>m in a?h(a,m,{enumerable:!0,configurable:!0,writable:!0,value:e}):a[m]=e;var n=(a,m,e)=>W(a,typeof m!="symbol"?m+"":m,e);var d=(a,m,e)=>new Promise((l,s)=>{var w=r=>{try{o(e.next(r))}catch(t){s(t)}},F=r=>{try{o(e.throw(r))}catch(t){s(t)}},o=r=>r.done?l(r.value):Promise.resolve(r.value).then(w,F);o((e=e.apply(a,m)).next())});import{b5 as A,aM as p,cm as D,G as x,l as u,H as T}from"./entry/index-C6uBgOW5-1730430676707.js";import{FlowDevModel as c}from"./EnumLab-CzismWql.js";import{useClassFactoryLoader as I}from"./useClassFactoryLoader-BD5OXTRg.js";import{GloComm as S}from"./GloComm-CmAl8MpM.js";import{b as N}from"./antd-Dd9L3uAF.js";import"./vue-BXIlYw1E.js";import"./FrmTrack-BAfWiAdt.js";import"./DBAccess-sLO0RM-h.js";import"./SFTable-BlM1UBse.js";import"./SFDBSrc-DKIMsnoa.js";import"./SFPara-T412M7pO.js";import"./SFColumn-CXmWKoZg.js";import"./MapAttr-B1mxD3vP.js";import"./Events-D9tOL1Ad.js";class M extends A{constructor(){super("GPN_NewFlowOfSaaS");n(this,"TaskTree",` 
  #### 帮助
...
`);n(this,"RefFrm",`
  ...
  #### 样例2
  ![输入图片说明](/resource/WF/Admin/Img/SDKFrm.png "屏幕截图.png")  
  `);this.PageTitle="新建流程"}Init(){return d(this,null,function*(){this.AddGroup("A","内置表单模式"),this.TextBox1_Name("JiJian","极简模式",this.JiJian,"流程名称","我的极简流程"),this.TextBox1_Name("Profession","专业模式",this.Profession,"流程名称","我的专业流程"),this.AddGroup("B","绑定表单模式"),this.TextBox1_Name("RefOneFrmTree","绑定单表单",this.RefFrm,"流程名称","我的单表单流程"),this.SelectItemsByGroupList("RefOneFrmTree.SelectOneFrm","选择表单",this.RefFrm_SelectOneFrm,!1,p.srcFrmTree,p.srcFrmList),this.TextBox1_Name("FrmTree","绑定多表单",this.FrmTree_SelectFrms,"流程名称","我的多表单流程"),this.SelectItemsByGroupList("FrmTree.SelectFrms","选择表单",this.FrmTree_SelectFrms,!0,p.srcFrmTree,p.srcFrmList),this.AddGroup("C","使用AI创建"),this.AddHelp("AI","使用AI创建","使用AI创建,调用AI大模型创建流程.");const e=S.UrlGPN("GPN_AIFlowNew","","&SortNo=123");this.AddGoToUrl("AI.AIFlow","使用AI创建",e)})}GenerEnsList(){return d(this,null,function*(){return yield(yield I("ClassFactory")).toJSON([])})}GenerSorts(){return d(this,null,function*(){const e=new D;return yield e.RetrieveAll(),e})}Save_TextBox_X(e,l,s,w,F){return d(this,null,function*(){if(e=="AI.AIFlow"){const o=S.UrlGPN("GPN_AIFlowNew","","&SortNo="+l);return new x(u.OpenUrlByNewWindow,o)}if(e==="Profession"||e==="JiJian"){const o=s,r=w;let t=c.Prefessional;e=="JiJian"&&(t=c.JiJian);const i=yield this.creteFlow(l,t,o,r,F);if(i==null)return;const f="/#/WF/Designer/EditFlow?FlowNo="+i;return new x(u.OpenUrlByNewWindow,f)}if(e=="SDKFrmWorkID"||e=="SDKFrmWorkID"||e=="QianRuFrm"){const o=w,r=s,t=yield this.creteFlow(l,c.SDKFrm,o,r,F);if(t==null)return;const i="/#/WF/Designer/EditFlow?FlowNo="+t;return new x(u.OpenUrlByNewWindow,i)}if(e==="RefOneFrmTree.SelectOneFrm"){const o=this.RequestVal("tb1","RefOneFrmTree"),r=s,t=yield this.creteFlow(l,c.RefOneFrmTree,o,r,F);if(t==null)return;const i="/#/WF/Designer/EditFlow?FlowNo="+t;return new x(u.OpenUrlByNewWindow,i)}if(e==="FrmTree.SelectFrms"){const o=this.RequestVal("tb1","FrmTree"),r=s,t=yield this.creteFlow(l,c.FrmTree,o,r,F);if(t==null)return;const i="/#/WF/Designer/EditFlow?FlowNo="+t;return new x(u.OpenUrlByNewWindow,i)}if(e==="FrmExcel"||e==="FrmWord"){const o=s,r=w;let t=c.FrmWord;e=="FrmExcel"&&(t=c.FrmExcel),e=="FrmWord"&&(t=c.FrmWord);const i=yield this.creteFlow(l,t,o,r,F);if(i==null)return;const f="/#/WF/Designer/EditFlow?FlowNo="+i;return new x(u.OpenUrlByNewWindow,f)}if(e==="TaskTreeSimple"){const o=s,r=w,t=c.TaskTree,i=yield this.creteFlow(l,t,o,r,F);if(i==null)return;N.info("流程创建成功,模板编号:"+i);const f="/#/WF/Designer/EditFlow?FlowNo="+i;return new x(u.OpenUrlByNewWindow,f)}})}creteFlow(e,l,s,w,F){return d(this,null,function*(){const o=new T("BP.WF.HttpHandler.WF_Admin_CCBPMDesigner_FlowDevModel");o.AddPara("SortNo",e),o.AddPara("FlowName",s),o.AddPara("FlowDevModel",l),o.AddPara("FrmUrl",w),o.AddPara("FrmPK",F);const r=yield o.DoMethodReturnString("FlowDevModel_Save_SaaS");return r==null||r==null?(N.info("创建失败:"+r),null):(N.info("流程创建成功,模板编号:"+r),r)})}}export{M as GPN_NewFlowOfSaaS};
