var l=Object.defineProperty;var n=(o,t,e)=>t in o?l(o,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):o[t]=e;var r=(o,t,e)=>n(o,typeof t!="symbol"?t+"":t,e);import{N as s,ba as a,a0 as d,U as D,L as T}from"./entry/index-M8VErHPE-1727507756861.js";import"./vue-DGeTOT5N.js";import"./antd-DkiF_jXA.js";class S extends s{constructor(e){super("TS.MapExt.PopTableSearch");r(this,"NoteSearchTip",` 
  #### 帮助
  - 显示在搜索文本框的背景文字，比如:
  - 请输入付款人名称,进行搜索。
  ...
  `);e&&(this.MyPK=e)}get HisUAC(){const e=new D;return e.IsDelete=!1,e.IsUpdate=!0,e.IsInsert=!1,e}get EnMap(){const e=new T("Sys_MapExt","表格弹窗");return e.AddGroupAttr("数据来源"),e.AddMyPK(),e.AddTBString(a.FK_MapData,null,"表单ID",!1,!1,0,50,200),e.AddTBString(a.ExtModel,"Pop","模式(大类)",!1,!1,0,50,200),e.AddTBString(a.ExtType,null,"类型(小类)",!1,!1,0,50,200),e.AddDDLEntities(a.FK_DBSrc,"local","数据源",new d,!0,null,!1),e.AddTBString("SearchTip",null,"搜索提示",!0,!1,0,50,200,!0,this.NoteSearchTip),e.AddTBStringDoc(a.Tag1,null,"查询条件设置",!0,!1,!0,this.NoteTag1),e.AddTBStringDoc(a.Tag2,null,"数据源",!0,!1,!0,this.NoteTag2),e.AddTBStringDoc(a.Tag3,null,"分页总数数据源",!0,!1,!0,this.NoteTag3),e.AddTBString(a.Tag,null,"数据列名与中文意思对照",!0,!1,0,50,200,!0,this.NoteTag),e.AddTBString(a.Tag5,null,"确定后执行的JS",!0,!1,0,50,200,!0,this.NoteTag5),e.AddGroupAttr("外观"),e.AddRadioBtn("ShowModel",0,"展示方式",!1,!1,"ShowModel","@0=POP弹出窗@1=下拉搜索选择",null,!0),e.AddRadioBtn("PopSelectType",1,"选择类型",!0,!0,"PopSelectType","@0=单选@1=多选",null,!0),e.AddBoolean("IsFirstLoad",!0,"打开是否直接加载数据",!0,!0,!1),e.AddTBString("Title",null,"标题",!0,!1,0,50,200,!0),e.AddTBString("BtnLab","查找","查找按钮标签",!0,!1,0,50,200),e.AddTBInt(a.H,500,"弹窗高度",!0,!1),e.AddTBInt(a.W,900,"弹窗宽度",!0,!1),e.AddTBAtParas(4e3),e.ParaFields=",Title,BtnLab,SearchTip,ShowModel,PopSelectType,IsFirstLoad,",this._enMap=e,this._enMap}}export{S as PopTableSearch};
