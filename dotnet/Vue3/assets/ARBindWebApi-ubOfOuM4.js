var g=Object.defineProperty;var D=(s,r,e)=>r in s?g(s,r,{enumerable:!0,configurable:!0,writable:!0,value:e}):s[r]=e;var a=(s,r,e)=>D(s,typeof r!="symbol"?r+"":r,e);var l=(s,r,e)=>new Promise((t,o)=>{var p=n=>{try{i(e.next(n))}catch(d){o(d)}},u=n=>{try{i(e.throw(n))}catch(d){o(d)}},i=n=>n.done?t(n.value):Promise.resolve(n.value).then(p,u);i((e=e.apply(s,r)).next())});import{N as T,aP as A,aQ as N,U,L as W,Y as h}from"./entry/index-M8VErHPE-1727507756861.js";import"./vue-DGeTOT5N.js";import"./antd-DkiF_jXA.js";class f extends T{constructor(e){super("TS.WF.ARBindWebApi");a(this,"Help",`
  ####  帮助
  ...
  #### 比如1：返回数据
   ...
   - 该模式不需要配置.
  `);e&&this.setPKVal(e)}get HisUAC(){const e=new U;return e.IsDelete=!1,e.IsUpdate=!0,e.IsInsert=!1,e}get EnMap(){const e=new W("WF_Part","绑定WebApi");e.AddGroupAttr("基本设置"),e.AddMyPK(),e.AddTBString("FlowNo",null,"FlowNo",!1,!1,0,800,100,!1),e.AddTBInt("NodeID",0,"NodeID",!1,!1),e.AddTBString("Tag0",null,"Url",!0,!1,0,800,100,!0,this.Help),e.AddDDLStringEnum("Tag1","Get","请求模式","@Get=Get模式@POST=Post模式",!0,""),e.AddTBStringDoc("Tag9",null,"备注",!0,!1,!0,this.Help),e.AddGroupAttr("POST设置"),e.AddDDLStringEnum("Tag2","0","参数模式","@0=自定义模式@1=全量模式",!0,this.HelpParaModel),e.AddTBStringDoc("Tag3",null,"自定义数据内容",!0,!1,!0,this.Help),e.AddDDLStringEnum("Tag4","0","数据格式","@0=From格式@1=JSON格式",!0,this.HelpParaModel);const t=new h;return t.Title="执行测试",t.RefMethodType=A.Func,t.HisAttrs.AddTBString("P",null,"输入参数",!0,!1,0,2e3,300,!0,"格式@BU=1001@PDT=1002"),t.Warning="您确定要执行吗？",t.ClassMethod="DoTest",e.AddRefMethod(t),this._enMap=e,this._enMap}DoTest(e){return l(this,null,function*(){const t=new N("BP.WF.Template.Part",this.MyPK);return yield t.Init(),yield t.Retrieve(),"tabOpen@接受人:"+(yield t.DoMethodReturnString("DoTestARWebApi",e))})}}export{f as ARBindWebApi};
