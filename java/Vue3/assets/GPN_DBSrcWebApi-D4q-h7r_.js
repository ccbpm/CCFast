var W=Object.defineProperty;var x=(s,i,r)=>i in s?W(s,i,{enumerable:!0,configurable:!0,writable:!0,value:r}):s[i]=r;var o=(s,i,r)=>x(s,typeof i!="symbol"?i+"":i,r);var l=(s,i,r)=>new Promise((N,c)=>{var a=t=>{try{e(r.next(t))}catch(p){c(p)}},n=t=>{try{e(r.throw(t))}catch(p){c(p)}},e=t=>t.done?N(t.value):Promise.resolve(t.value).then(a,n);e((r=r.apply(s,i)).next())});import{SFProcedure as T}from"./SFProcedure-CE1gQz0T.js";import{S as d}from"./DBAccess-sLO0RM-h.js";import{SFTable as u}from"./SFTable-BlM1UBse.js";import{b5 as D,G as S,l as m,D as h}from"./entry/index-C6uBgOW5-1730430676707.js";import{GloComm as b}from"./GloComm-CmAl8MpM.js";import"./SFDBSrc-DKIMsnoa.js";import"./vue-BXIlYw1E.js";import"./antd-Dd9L3uAF.js";import"./SFPara-T412M7pO.js";import"./MapAttr-B1mxD3vP.js";import"./Events-D9tOL1Ad.js";import"./SFParaSln-BnGoh0gJ.js";import"./SFColumn-CXmWKoZg.js";import"./FrmTrack-BAfWiAdt.js";class K extends D{constructor(){super("GPN_DBSrcWebApi");o(this,"HelpSearch",`
  #### 帮助
  - 查询与字典表不同，他需要参数据才能执行.
  #### 用到场景
  - 文本框自动完成, 级联下拉框、自动填充.
