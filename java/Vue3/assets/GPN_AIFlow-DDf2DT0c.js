var W=Object.defineProperty;var p=(l,s,t)=>s in l?W(l,s,{enumerable:!0,configurable:!0,writable:!0,value:t}):l[s]=t;var a=(l,s,t)=>p(l,typeof s!="symbol"?s+"":s,t);var d=(l,s,t)=>new Promise((e,n)=>{var u=r=>{try{i(t.next(r))}catch(o){n(o)}},c=r=>{try{i(t.throw(r))}catch(o){n(o)}},i=r=>r.done?e(r.value):Promise.resolve(r.value).then(u,c);i((t=t.apply(l,s)).next())});import{b5 as g,G as h,l as w}from"./entry/index-C6uBgOW5-1730430676707.js";import A from"./HttpHandler-DNmkgeyq.js";import"./vue-BXIlYw1E.js";import"./antd-Dd9L3uAF.js";import"./Events-D9tOL1Ad.js";class b extends g{constructor(){super("GPN_AIFlow");a(this,"AlertCar",`
    我要做一个车辆申请流程，如
